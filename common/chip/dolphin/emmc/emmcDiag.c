...
{
/* do nothing due to API change for DOLPHIN */
}
...
UINT_T EMMCHC_Init(void)
{
	...
	//step 2~8
	// According to: DOLPHIN DIAG hardware configuration note[030921], identification
...
*/
	...
	// According to: DOLPHIN DIAG hardware configuration note[030921], HS SDR50
