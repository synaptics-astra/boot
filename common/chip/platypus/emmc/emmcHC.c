...
//step 2~8
void SDHC_PHYDelayLineSetup(P_MM4_SDMMC_CONTEXT_T pContext)
{
    unsigned int mm4_regaddr = (uintptr_t)(pContext->pMMC4Reg);

    DL_REGS_0_UNION DL_regs_0;
    DL_REGS_1_UNION DL_regs_1;

    sd_reg_get(mm4_regaddr + PHY_COMMDL_CNFG_REG_OFFSET, DL_regs_0.dl_regs_0_value);
    sd_reg_get(mm4_regaddr + PHY_SMPLDL_CNFG_REG_OFFSET, DL_regs_1.dl_regs_1_value);

    //ZL: Dolphin_BG7_PHY_bring_up_sequence.xlsx
    //step 2~3
    DL_regs_0.dl_regs_0_bits.dlstep_sel    = 0;
    DL_regs_0.dl_regs_0_bits.dlout_en      = 0;
    DL_regs_0.dl_regs_0_bits.update_dc     = 0;
    DL_regs_0.dl_regs_0_bits.inpsel_cnfg   = 0;
    DL_regs_0.dl_regs_0_bits.bypass_en     = 0;
    DL_regs_0.dl_regs_0_bits.extdly_en     = 0;
    sd_reg_set(mm4_regaddr + PHY_COMMDL_CNFG_REG_OFFSET, DL_regs_0.dl_regs_0_value);

    //ZL: Dolphin_BG7_PHY_bring_up_sequence.xlsx
    //step 4~5
    DL_regs_1.dl_regs_1_bits.s_inpsel_override      = 0;
    DL_regs_1.dl_regs_1_bits.s_inpsel_cnfg          = 0x3;
    DL_regs_1.dl_regs_1_bits.s_bypass_en            = 0;
    DL_regs_1.dl_regs_1_bits.s_extdly_en            = 0;
    DL_regs_1.dl_regs_1_bits.a_inpsel_cnfg          = 0x3;
    DL_regs_1.dl_regs_1_bits.a_bypass_en            = 0;
    DL_regs_1.dl_regs_1_bits.a_extdly_en            = 0;
    sd_reg_set(mm4_regaddr + PHY_SMPLDL_CNFG_REG_OFFSET, DL_regs_1.dl_regs_1_value);

    //ZL: Dolphin_BG7_PHY_bring_up_sequence.xlsx
    //step 6~8
    sd_reg_get(mm4_regaddr + PHY_COMMDL_CNFG_REG_OFFSET, DL_regs_0.dl_regs_0_value);
    DL_regs_0.dl_regs_0_bits.update_dc      = 1;
    sd_reg_set(mm4_regaddr + PHY_COMMDL_CNFG_REG_OFFSET, DL_regs_0.dl_regs_0_value);

    DL_regs_0.dl_regs_0_bits.cckdl_dc       = 26;
    sd_reg_set(mm4_regaddr + PHY_COMMDL_CNFG_REG_OFFSET, DL_regs_0.dl_regs_0_value);
