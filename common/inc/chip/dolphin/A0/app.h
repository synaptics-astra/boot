...
///                                    ###
///                                    * This flag is set when the CMDSIZE in appExeSram does not match the actual size of the commands been executed. For example, CMDSIZE is 1 (indicates 2 DW), but the command been executed is appSrc, which required 6 DW.
///                                    ###
///               %%        29         # Stuffing bits...
///     @ 0x00004 DmaStatus            (R-)
