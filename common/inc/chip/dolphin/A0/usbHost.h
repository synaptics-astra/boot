...
///                                    * OTG Charge detect
///                                    ###
///     @ 0x0000C OTGChargeDetect      (R-)
///               %unsigned 1  OUT                       
///                                    ###
///                                    * Charger detector output
///                                    * 1: Charger is detected on DP/DM
///                                    * 0: No charger is detected on DP/DM
///                                    * For OTG PHY with charge detect only
///                                    * Please follow the Ch7 in USBPHY document to get the correct output.
///                                    ###
///               %%        31         # Stuffing bits...
///     # # ----------------------------------------------------------
/// $ENDOFINTERFACE  # size:      16B, bits:      41b, padding:     0B
////////////////////////////////////////////////////////////
#ifndef h_usbPhy
#define h_usbPhy (){}
    ...
    ///////////////////////////////////////////////////////////
    #define     RA_usbPhy_OTGChargeDetect                      0x000C

    #define     BA_usbPhy_OTGChargeDetect_OUT                  0x000C
    #define     B16usbPhy_OTGChargeDetect_OUT                  0x000C
    #define   LSb32usbPhy_OTGChargeDetect_OUT                     0
    #define   LSb16usbPhy_OTGChargeDetect_OUT                     0
    #define       busbPhy_OTGChargeDetect_OUT                  1
    #define   MSK32usbPhy_OTGChargeDetect_OUT                     0x00000001
    ///////////////////////////////////////////////////////////
    ...
    ///////////////////////////////////////////////////////////
    #define   GET32usbPhy_OTGChargeDetect_OUT(r32)             _BFGET_(r32, 0, 0)
    #define   SET32usbPhy_OTGChargeDetect_OUT(r32,v)           _BFSET_(r32, 0, 0,v)
    #define   GET16usbPhy_OTGChargeDetect_OUT(r16)             _BFGET_(r16, 0, 0)
    #define   SET16usbPhy_OTGChargeDetect_OUT(r16,v)           _BFSET_(r16, 0, 0,v)

    #define     w32usbPhy_OTGChargeDetect                      {\
            UNSG32 uOTGChargeDetect_OUT                        :  1;\
            UNSG32 RSVDxC_b1                                   : 31;\
          }
    union { UNSG32 u32usbPhy_OTGChargeDetect;
            struct w32usbPhy_OTGChargeDetect;
          };
    ///////////////////////////////////////////////////////////
    } SIE_usbPhy;
    ...
    typedef union  T32usbPhy_OTGChargeDetect
          { UNSG32 u32;
            struct w32usbPhy_OTGChargeDetect;
                 } T32usbPhy_OTGChargeDetect;
    ///////////////////////////////////////////////////////////
    ...
    typedef union  TusbPhy_OTGChargeDetect
          { UNSG32 u32[1];
            struct {
            struct w32usbPhy_OTGChargeDetect;
                   };
                 } TusbPhy_OTGChargeDetect;
