...
///                                    * 1: enable
///                                    ###
///               %unsigned 1  OUTOFRANGE_INT_EN         0x1
///                                    ###
...
#define h_ADC (){}
    ...
    #define     BA_ADC_CTRL_OUTOFRANGE_INT_EN                  0x0002
    #define     B16ADC_CTRL_OUTOFRANGE_INT_EN                  0x0002
    #define   LSb32ADC_CTRL_OUTOFRANGE_INT_EN                     21
    #define   LSb16ADC_CTRL_OUTOFRANGE_INT_EN                     5
    #define       bADC_CTRL_OUTOFRANGE_INT_EN                  1
    #define   MSK32ADC_CTRL_OUTOFRANGE_INT_EN                     0x00200000
    ///////////////////////////////////////////////////////////
    ...
    ///////////////////////////////////////////////////////////
    #define     RA_ADC_DATA_CHK_CTRL                           0x000C

    #define     BA_ADC_DATA_CHK_CTRL_ADC_DATA_HIGH             0x000C
    #define     B16ADC_DATA_CHK_CTRL_ADC_DATA_HIGH             0x000C
    #define   LSb32ADC_DATA_CHK_CTRL_ADC_DATA_HIGH                0
    #define   LSb16ADC_DATA_CHK_CTRL_ADC_DATA_HIGH                0
    #define       bADC_DATA_CHK_CTRL_ADC_DATA_HIGH             12
    #define   MSK32ADC_DATA_CHK_CTRL_ADC_DATA_HIGH                0x00000FFF

    #define     BA_ADC_DATA_CHK_CTRL_ADC_DATA_LOW              0x000D
    #define     B16ADC_DATA_CHK_CTRL_ADC_DATA_LOW              0x000C
    #define   LSb32ADC_DATA_CHK_CTRL_ADC_DATA_LOW                 12
    #define   LSb16ADC_DATA_CHK_CTRL_ADC_DATA_LOW                 12
    #define       bADC_DATA_CHK_CTRL_ADC_DATA_LOW              12
    #define   MSK32ADC_DATA_CHK_CTRL_ADC_DATA_LOW                 0x00FFF000
    ///////////////////////////////////////////////////////////
    ...
    #define   GET32ADC_CTRL_OUTOFRANGE_INT_EN(r32)             _BFGET_(r32,21,21)
    #define   SET32ADC_CTRL_OUTOFRANGE_INT_EN(r32,v)           _BFSET_(r32,21,21,v)
    #define   GET16ADC_CTRL_OUTOFRANGE_INT_EN(r16)             _BFGET_(r16, 5, 5)
    #define   SET16ADC_CTRL_OUTOFRANGE_INT_EN(r16,v)           _BFSET_(r16, 5, 5,v)
    ...
    #define     w32ADC_CTRL                                    {\
            ...
            UNSG32 uCTRL_OUTOFRANGE_INT_EN                     :  1;\
    ...
    ///////////////////////////////////////////////////////////
    #define   GET32ADC_DATA_CHK_CTRL_ADC_DATA_HIGH(r32)        _BFGET_(r32,11, 0)
    #define   SET32ADC_DATA_CHK_CTRL_ADC_DATA_HIGH(r32,v)      _BFSET_(r32,11, 0,v)
    #define   GET16ADC_DATA_CHK_CTRL_ADC_DATA_HIGH(r16)        _BFGET_(r16,11, 0)
    #define   SET16ADC_DATA_CHK_CTRL_ADC_DATA_HIGH(r16,v)      _BFSET_(r16,11, 0,v)

    #define   GET32ADC_DATA_CHK_CTRL_ADC_DATA_LOW(r32)         _BFGET_(r32,23,12)
    #define   SET32ADC_DATA_CHK_CTRL_ADC_DATA_LOW(r32,v)       _BFSET_(r32,23,12,v)

    #define     w32ADC_DATA_CHK_CTRL                           {\
            UNSG32 uDATA_CHK_CTRL_ADC_DATA_HIGH                : 12;\
            UNSG32 uDATA_CHK_CTRL_ADC_DATA_LOW                 : 12;\
            UNSG32 RSVDxC_b24                                  :  8;\
          }
    union { UNSG32 u32ADC_DATA_CHK_CTRL;
            struct w32ADC_DATA_CHK_CTRL;
          };
    ///////////////////////////////////////////////////////////
    } SIE_ADC;
    ...
    typedef union  T32ADC_DATA_CHK_CTRL
          { UNSG32 u32;
            struct w32ADC_DATA_CHK_CTRL;
                 } T32ADC_DATA_CHK_CTRL;
    ///////////////////////////////////////////////////////////
    ...
    typedef union  TADC_DATA_CHK_CTRL
          { UNSG32 u32[1];
            struct {
            struct w32ADC_DATA_CHK_CTRL;
                   };
