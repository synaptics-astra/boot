//////
/// don't edit! auto-generated by docc: iMtest.h
////////////////////////////////////////////////////////////
#ifndef iMtest_h
#define iMtest_h (){}
...
///     @ 0x00800 CTRL0                (RW-)
///               ###
///               * iMtest Control Register
///               ###
///               %unsigned 4  imt_sel                   0x0
///                                    ###
///                                    * 1 bit per engine. When the corresponding bit is set to 1, imt_active will start that engine.
///                                    ###
///               %unsigned 4  imt_loop                  
///                                    ###
///                                    * 1 bit per engine. When the corresponding bit is set to 1, that engine will loop
///                                    ###
///               %unsigned 4  imt_wr_nochk              0x0
///                                    ###
///                                    * 1 bit per engine. When the corresponding bit is set to 1, the engine will generate only write traffic and the checker is disabled
///                                    ###
///               %unsigned 4  imt_rd_nochk              0x0
///                                    ###
///                                    * 1 bit per engine. When the corresponding bit is set to 1, the engine will generate only read traffic and the checker is disable
///                                    ###
///               %%        16         # Stuffing bits...
///     @ 0x00804 CTRL1                (RW-)
///               %unsigned 1  imt_active                0x0
///                                    ###
///                                    * Depending on imt_sel[3:0], setting imt_active to 1 will start the selected mtest engines.
///                                    * Value self clears after all mtest engines selected are done.
///                                    * Note: If any of the engines are set on a loop, this bit will not clear till the engine's looping is stopped.
///                                    ###
///               %%        31         # Stuffing bits...
///     @ 0x00808 STATUS               (RW-)
///               %unsigned 4  imt_done                  0x0
///                                    ###
///                                    * Done flag. 1 per engine
///                                    * For each bit, imt_done[n]
///                                    * 0: MTEST is active
///                                    * 1: Single loop is done for respective engine
///                                    ###
///               %unsigned 4  imt_error                 0x0
///               %%        24         # Stuffing bits...
///     # # ----------------------------------------------------------
/// $ENDOFINTERFACE  # size:    2060B, bits:    2869b, padding:     0B
////////////////////////////////////////////////////////////
#ifndef h_iMtest
#define h_iMtest (){}

    #define     RA_iMtest_MTEST0                               0x0000
    ///////////////////////////////////////////////////////////
    #define     RA_iMtest_MTEST1                               0x0100
    ///////////////////////////////////////////////////////////
    #define     RA_iMtest_MTEST2                               0x0200
    ///////////////////////////////////////////////////////////
    #define     RA_iMtest_MTEST3                               0x0300
    ///////////////////////////////////////////////////////////
    #define     RA_iMtest_CTRL0                                0x0800

    #define     BA_iMtest_CTRL0_imt_sel                        0x0800
    #define     B16iMtest_CTRL0_imt_sel                        0x0800
    #define   LSb32iMtest_CTRL0_imt_sel                           0
    #define   LSb16iMtest_CTRL0_imt_sel                           0
    #define       biMtest_CTRL0_imt_sel                        4
    #define   MSK32iMtest_CTRL0_imt_sel                           0x0000000F

    #define     BA_iMtest_CTRL0_imt_loop                       0x0800
    #define     B16iMtest_CTRL0_imt_loop                       0x0800
    #define   LSb32iMtest_CTRL0_imt_loop                          4
    #define   LSb16iMtest_CTRL0_imt_loop                          4
    #define       biMtest_CTRL0_imt_loop                       4
    #define   MSK32iMtest_CTRL0_imt_loop                          0x000000F0

    #define     BA_iMtest_CTRL0_imt_wr_nochk                   0x0801
    #define     B16iMtest_CTRL0_imt_wr_nochk                   0x0800
    #define   LSb32iMtest_CTRL0_imt_wr_nochk                      8
    #define   LSb16iMtest_CTRL0_imt_wr_nochk                      8
    #define       biMtest_CTRL0_imt_wr_nochk                   4
    #define   MSK32iMtest_CTRL0_imt_wr_nochk                      0x00000F00

    #define     BA_iMtest_CTRL0_imt_rd_nochk                   0x0801
    #define     B16iMtest_CTRL0_imt_rd_nochk                   0x0800
    #define   LSb32iMtest_CTRL0_imt_rd_nochk                      12
    #define   LSb16iMtest_CTRL0_imt_rd_nochk                      12
    #define       biMtest_CTRL0_imt_rd_nochk                   4
    #define   MSK32iMtest_CTRL0_imt_rd_nochk                      0x0000F000
    ///////////////////////////////////////////////////////////
    #define     RA_iMtest_CTRL1                                0x0804

    #define     BA_iMtest_CTRL1_imt_active                     0x0804
    #define     B16iMtest_CTRL1_imt_active                     0x0804
    #define   LSb32iMtest_CTRL1_imt_active                        0
    #define   LSb16iMtest_CTRL1_imt_active                        0
    #define       biMtest_CTRL1_imt_active                     1
    #define   MSK32iMtest_CTRL1_imt_active                        0x00000001
    ///////////////////////////////////////////////////////////
    #define     RA_iMtest_STATUS                               0x0808

    #define     BA_iMtest_STATUS_imt_done                      0x0808
    #define     B16iMtest_STATUS_imt_done                      0x0808
    #define   LSb32iMtest_STATUS_imt_done                         0
    #define   LSb16iMtest_STATUS_imt_done                         0
    #define       biMtest_STATUS_imt_done                      4
    #define   MSK32iMtest_STATUS_imt_done                         0x0000000F

    #define     BA_iMtest_STATUS_imt_error                     0x0808
    #define     B16iMtest_STATUS_imt_error                     0x0808
    #define   LSb32iMtest_STATUS_imt_error                        4
    #define   LSb16iMtest_STATUS_imt_error                        4
    #define       biMtest_STATUS_imt_error                     4
    #define   MSK32iMtest_STATUS_imt_error                        0x000000F0
    ///////////////////////////////////////////////////////////

    typedef struct SIE_iMtest {
    ///////////////////////////////////////////////////////////
              SIE_Mtest                                        ie_MTEST0;
    ///////////////////////////////////////////////////////////
             UNSG8 RSVDx60                                     [160];
    ...
    ///////////////////////////////////////////////////////////
             UNSG8 RSVDx360                                    [1184];
    ///////////////////////////////////////////////////////////
    #define   GET32iMtest_CTRL0_imt_sel(r32)                   _BFGET_(r32, 3, 0)
    #define   SET32iMtest_CTRL0_imt_sel(r32,v)                 _BFSET_(r32, 3, 0,v)
    #define   GET16iMtest_CTRL0_imt_sel(r16)                   _BFGET_(r16, 3, 0)
    #define   SET16iMtest_CTRL0_imt_sel(r16,v)                 _BFSET_(r16, 3, 0,v)

    #define   GET32iMtest_CTRL0_imt_loop(r32)                  _BFGET_(r32, 7, 4)
    #define   SET32iMtest_CTRL0_imt_loop(r32,v)                _BFSET_(r32, 7, 4,v)
    #define   GET16iMtest_CTRL0_imt_loop(r16)                  _BFGET_(r16, 7, 4)
    #define   SET16iMtest_CTRL0_imt_loop(r16,v)                _BFSET_(r16, 7, 4,v)

    #define   GET32iMtest_CTRL0_imt_wr_nochk(r32)              _BFGET_(r32,11, 8)
    #define   SET32iMtest_CTRL0_imt_wr_nochk(r32,v)            _BFSET_(r32,11, 8,v)
    #define   GET16iMtest_CTRL0_imt_wr_nochk(r16)              _BFGET_(r16,11, 8)
    #define   SET16iMtest_CTRL0_imt_wr_nochk(r16,v)            _BFSET_(r16,11, 8,v)

    #define   GET32iMtest_CTRL0_imt_rd_nochk(r32)              _BFGET_(r32,15,12)
    #define   SET32iMtest_CTRL0_imt_rd_nochk(r32,v)            _BFSET_(r32,15,12,v)
    #define   GET16iMtest_CTRL0_imt_rd_nochk(r16)              _BFGET_(r16,15,12)
    #define   SET16iMtest_CTRL0_imt_rd_nochk(r16,v)            _BFSET_(r16,15,12,v)

    #define     w32iMtest_CTRL0                                {\
            UNSG32 uCTRL0_imt_sel                              :  4;\
            UNSG32 uCTRL0_imt_loop                             :  4;\
            UNSG32 uCTRL0_imt_wr_nochk                         :  4;\
            UNSG32 uCTRL0_imt_rd_nochk                         :  4;\
            UNSG32 RSVDx800_b16                                : 16;\
          }
    union { UNSG32 u32iMtest_CTRL0;
            struct w32iMtest_CTRL0;
          };
    ///////////////////////////////////////////////////////////
    #define   GET32iMtest_CTRL1_imt_active(r32)                _BFGET_(r32, 0, 0)
    #define   SET32iMtest_CTRL1_imt_active(r32,v)              _BFSET_(r32, 0, 0,v)
    #define   GET16iMtest_CTRL1_imt_active(r16)                _BFGET_(r16, 0, 0)
    #define   SET16iMtest_CTRL1_imt_active(r16,v)              _BFSET_(r16, 0, 0,v)

    #define     w32iMtest_CTRL1                                {\
            UNSG32 uCTRL1_imt_active                           :  1;\
            UNSG32 RSVDx804_b1                                 : 31;\
          }
    union { UNSG32 u32iMtest_CTRL1;
            struct w32iMtest_CTRL1;
          };
    ///////////////////////////////////////////////////////////
    #define   GET32iMtest_STATUS_imt_done(r32)                 _BFGET_(r32, 3, 0)
    #define   SET32iMtest_STATUS_imt_done(r32,v)               _BFSET_(r32, 3, 0,v)
    #define   GET16iMtest_STATUS_imt_done(r16)                 _BFGET_(r16, 3, 0)
    #define   SET16iMtest_STATUS_imt_done(r16,v)               _BFSET_(r16, 3, 0,v)

    #define   GET32iMtest_STATUS_imt_error(r32)                _BFGET_(r32, 7, 4)
    #define   SET32iMtest_STATUS_imt_error(r32,v)              _BFSET_(r32, 7, 4,v)
    #define   GET16iMtest_STATUS_imt_error(r16)                _BFGET_(r16, 7, 4)
    #define   SET16iMtest_STATUS_imt_error(r16,v)              _BFSET_(r16, 7, 4,v)

    #define     w32iMtest_STATUS                               {\
            UNSG32 uSTATUS_imt_done                            :  4;\
            UNSG32 uSTATUS_imt_error                           :  4;\
            UNSG32 RSVDx808_b8                                 : 24;\
          }
    union { UNSG32 u32iMtest_STATUS;
            struct w32iMtest_STATUS;
          };
    ///////////////////////////////////////////////////////////
    } SIE_iMtest;

    typedef union  T32iMtest_CTRL0
          { UNSG32 u32;
            struct w32iMtest_CTRL0;
                 } T32iMtest_CTRL0;
    typedef union  T32iMtest_CTRL1
          { UNSG32 u32;
            struct w32iMtest_CTRL1;
                 } T32iMtest_CTRL1;
    typedef union  T32iMtest_STATUS
          { UNSG32 u32;
            struct w32iMtest_STATUS;
                 } T32iMtest_STATUS;
    ///////////////////////////////////////////////////////////

    typedef union  TiMtest_CTRL0
          { UNSG32 u32[1];
            struct {
            struct w32iMtest_CTRL0;
                   };
                 } TiMtest_CTRL0;
    typedef union  TiMtest_CTRL1
          { UNSG32 u32[1];
            struct {
            struct w32iMtest_CTRL1;
                   };
                 } TiMtest_CTRL1;
    typedef union  TiMtest_STATUS
          { UNSG32 u32[1];
            struct {
            struct w32iMtest_STATUS;
                   };
    ...
    ///////////////////////////////////////////////////////////
     SIGN32 iMtest_drvrd(SIE_iMtest *p, UNSG32 base, SIGN32 mem, SIGN32 tst);
     SIGN32 iMtest_drvwr(SIE_iMtest *p, UNSG32 base, SIGN32 mem, SIGN32 tst, UNSG32 *pcmd);
       void iMtest_reset(SIE_iMtest *p);
     SIGN32 iMtest_cmp  (SIE_iMtest *p, SIE_iMtest *pie, char *pfx, void *hLOG, SIGN32 mem, SIGN32 tst);
    #define iMtest_check(p,pie,pfx,hLOG) iMtest_cmp(p,pie,pfx,(void*)(hLOG),0,0)
    #define iMtest_print(p,    pfx,hLOG) iMtest_cmp(p,0,  pfx,(void*)(hLOG),0,0)

#endif
//////
/// ENDOFINTERFACE: iMtest
////////////////////////////////////////////////////////////
