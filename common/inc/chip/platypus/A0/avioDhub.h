...
///                                    : 1DSCL_W1                  0x4
///                                                 ###
///                                                 * 1D Scalar HDMI-RX Write1 (2ND) Channel
///                                                 * BANK #2
///                                                 ###
///                                    : MetaData_RD               0x5
///                                                 ###
...
///                                    : DBEDR_RD_C                0x7
///                                                 ###
///                                                 * DB EDR Read/Offline Scalar (2ND) C Channel
///                                                 * BANK #3
///                                                 ###
///                                    : DBEDR_RD                  0x8
///                                                 ###
...
///                                    : 1DSCL_W0                  0x9
///                                                 ###
///                                                 * 1D Scalar HDMI-RX Write0 (2ND) Channel
///                                                 ###
///               %%        28         # Stuffing bits...
///     @ 0x00004                      (P)
///               %unsigned 4  aio64b
...
///                                    : MIC3_CH_W                 0x9
///                                                 ###
///                                                 * MIC3 (HDMI-RX Audio) write (1D) channel - Unused
///                                                 ###
///                                    : MIC4_CH_W                 0xA
///                                                 ###
...
///               : vpp128bDhub_BANK0_SIZE 0x3C00
///               : vpp128bDhub_BANK1_START_ADDR 0x3C00
///               : vpp128bDhub_BANK1_SIZE 0x3C00
///               : vpp128bDhub_BANK2_START_ADDR 0x7800
///               : vpp128bDhub_BANK2_SIZE 0x3C00
///               : vpp128bDhub_BANK3_START_ADDR 0xB400
///               : vpp128bDhub_BANK3_SIZE 0x3C00
///               : aio64bDhub_BANK0_START_ADDR 0x0
///               : aio64bDhub_BANK0_SIZE 0x4A00
///     @ 0x00000 dummy                (P)
///               %unsigned 1  xxx
///               %%        31         # Stuffing bits...
///     # # ----------------------------------------------------------
...
#define h_avioDhubSemMap (){}
    ...
    #define     BA_avioDhubSemMap_csi128b                      0x0004
    #define     B16avioDhubSemMap_csi128b                      0x0004
    #define   LSb32avioDhubSemMap_csi128b                         0
    #define   LSb16avioDhubSemMap_csi128b                         0
    #define       bavioDhubSemMap_csi128b                      5
    #define   MSK32avioDhubSemMap_csi128b                         0x0000001F
    ...
    #define     BA_avioDhubSemMap_aio64b                       0x0008
    #define     B16avioDhubSemMap_aio64b                       0x0008
    ...
    #define   SET16avioDhubSemMap_vpp128b(r16,v)               _BFSET_(r16, 4, 0,v)
            ...
            UNSG32 RSVDx0_b5                                   : 27;
    ///////////////////////////////////////////////////////////
    #define   GET32avioDhubSemMap_csi128b(r32)                 _BFGET_(r32, 4, 0)
    #define   SET32avioDhubSemMap_csi128b(r32,v)               _BFSET_(r32, 4, 0,v)
    #define   GET16avioDhubSemMap_csi128b(r16)                 _BFGET_(r16, 4, 0)
    #define   SET16avioDhubSemMap_csi128b(r16,v)               _BFSET_(r16, 4, 0,v)
...
///     @ 0x00000                      (P)
///     # 0x00000 tcm0
///               $vppTcmEntry         tcm0              MEM   [13824]
///                                    ###
///                                    * Real tcm size is 13.5K*4 = 54KB
///                                    ###
///     @ 0x10000                      (P)
///     # 0x10000 dHub0
///               $dHubReg2D           dHub0             REG
...
///     @ 0x00000                      (P)
///     # 0x00000 tcm0
///               $vppTcmEntry         tcm0              MEM    [4736]
///                                    ###
///                                    * Real tcm size is 18.5K*1= 18.5KB
///                                    ###
///     @ 0x08000                      (P)
///     # 0x08000 dHub0
///               $dHubReg2D           dHub0             REG
