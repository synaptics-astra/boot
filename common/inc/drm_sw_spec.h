...
typedef struct SIE_StreamHdr {
	...
	#define	w32StreamHdr_FUNC 			{										\
					UINT32				uFUNC_rdFunc				 : 12;		\
					UINT32				uFUNC_uStrmType				 :  4;		\
					UINT32				uFUNC_wrFunc				 : 12;		\
					UINT32				uFUNC_algnFactor			 :  4;		\
										}
	/* @'00000 */	union {	UINT32		u32StreamHdr_FUNC;
	...
	#define	w32StreamHdr_INFO 			{										\
					UINT32				uINFO_datPtr				 : 16;		\
					UINT32				uINFO_ctrlPtr				 : 16;		\
										}
	/* @'00004 */	union {	UINT32		u32StreamHdr_INFO;
...
INT32	StreamHdr_drvrd (SIE_StreamHdr *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	StreamHdr_drvwr (SIE_StreamHdr *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	StreamHdr_cmp   (SIE_StreamHdr *p, SIE_StreamHdr *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	StreamHdr_import(SIE_StreamHdr *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	StreamHdr_export(SIE_StreamHdr *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	HBOADDR_drvrd (SIE_HBOADDR *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	HBOADDR_drvwr (SIE_HBOADDR *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	HBOADDR_cmp   (SIE_HBOADDR *p, SIE_HBOADDR *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	HBOADDR_import(SIE_HBOADDR *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	HBOADDR_export(SIE_HBOADDR *p, char *regs);
...
typedef struct SIE_UINT32 {
	...
	#define	w32UINT32_V32 				{										\
					UINT32				uV32_uV16L					 : 16;		\
					UINT32				uV32_uV16H					 : 16;		\
										}
	/* @'00000 */	union {	UINT32		u32UINT32_V32;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	UINT32_drvrd (SIE_UINT32 *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	UINT32_drvwr (SIE_UINT32 *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	UINT32_cmp   (SIE_UINT32 *p, SIE_UINT32 *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	UINT32_import(SIE_UINT32 *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	UINT32_export(SIE_UINT32 *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	UINT64_drvrd (SIE_UINT64 *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	UINT64_drvwr (SIE_UINT64 *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	UINT64_cmp   (SIE_UINT64 *p, SIE_UINT64 *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	UINT64_import(SIE_UINT64 *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	UINT64_export(SIE_UINT64 *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	UINT128_drvrd (SIE_UINT128 *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	UINT128_drvwr (SIE_UINT128 *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	UINT128_cmp   (SIE_UINT128 *p, SIE_UINT128 *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	UINT128_import(SIE_UINT128 *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	UINT128_export(SIE_UINT128 *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	UINT1024_drvrd (SIE_UINT1024 *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	UINT1024_drvwr (SIE_UINT1024 *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	UINT1024_cmp   (SIE_UINT1024 *p, SIE_UINT1024 *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	UINT1024_import(SIE_UINT1024 *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	UINT1024_export(SIE_UINT1024 *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	FIGOSYSLIB_drvrd (SIE_FIGOSYSLIB *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	FIGOSYSLIB_drvwr (SIE_FIGOSYSLIB *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	FIGOSYSLIB_cmp   (SIE_FIGOSYSLIB *p, SIE_FIGOSYSLIB *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	FIGOSYSLIB_import(SIE_FIGOSYSLIB *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	FIGOSYSLIB_export(SIE_FIGOSYSLIB *p, char *regs);
...
typedef struct SIE_FIGOCtrl {
	...
	#define	w32FIGOCtrl_HDR 			{										\
					UINT32				uHDR_uFlag					 :  8;		\
					UINT32				uHDR_SourceId				 :  8;		\
					UINT32				uHDR_OutBufId				 :  8;		\
					UINT32				uHDR_cmdSize				 :  8;		\
										}
	/* @'00000 */	union {	UINT32		u32FIGOCtrl_HDR;
	...
	#define	w32FIGOCtrl_HDR1 			{										\
					UINT32				uHDR_uSyncPoint				 : 32;		\
										}
	/* @'00004 */	union {	UINT32		u32FIGOCtrl_HDR1;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	FIGOCtrl_drvrd (SIE_FIGOCtrl *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	FIGOCtrl_drvwr (SIE_FIGOCtrl *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	FIGOCtrl_cmp   (SIE_FIGOCtrl *p, SIE_FIGOCtrl *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	FIGOCtrl_import(SIE_FIGOCtrl *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	FIGOCtrl_export(SIE_FIGOCtrl *p, char *regs);
...
typedef struct SIE_FIGOEvent {
	...
	#define	w32FIGOEvent_PTRINFO 		{										\
					UINT32				uPTRINFO_nFifoOffset		 : 32;		\
										}
	/* @'00038 */	union {	UINT32		u32FIGOEvent_PTRINFO;
	...
	#define	w32FIGOEvent_PTRINFO1 		{										\
					UINT32				uPTRINFO_uDSFifo32PtrAddr	 : 16;		\
					UINT32				uPTRINFO_uEnFlag			 :  1;		\
					UINT32				uPTRINFO_Reserved			 : 15;		\
										}
	/* @'0003C */	union {	UINT32		u32FIGOEvent_PTRINFO1;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	FIGOEvent_drvrd (SIE_FIGOEvent *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	FIGOEvent_drvwr (SIE_FIGOEvent *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	FIGOEvent_cmp   (SIE_FIGOEvent *p, SIE_FIGOEvent *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	FIGOEvent_import(SIE_FIGOEvent *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	FIGOEvent_export(SIE_FIGOEvent *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DTCMFifo_drvrd (SIE_DTCMFifo *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DTCMFifo_drvwr (SIE_DTCMFifo *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DTCMFifo_cmp   (SIE_DTCMFifo *p, SIE_DTCMFifo *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DTCMFifo_import(SIE_DTCMFifo *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DTCMFifo_export(SIE_DTCMFifo *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DSFifo32_drvrd (SIE_DSFifo32 *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DSFifo32_drvwr (SIE_DSFifo32 *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DSFifo32_cmp   (SIE_DSFifo32 *p, SIE_DSFifo32 *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DSFifo32_import(SIE_DSFifo32 *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DSFifo32_export(SIE_DSFifo32 *p, char *regs);
...
typedef struct SIE_DTCMBlk {
	...
	#define	w32DTCMBlk_HDR 				{										\
					UINT32				uHDR_isDSFinished			 :  1;		\
					UINT32				uHDR_nReserved				 : 15;		\
					UINT32				uHDR_uBackDSID				 : 16;		\
										}
	/* @'00000 */	union {	UINT32		u32DTCMBlk_HDR;
	...
	#define	w32DTCMBlk_HDR1 			{										\
					UINT32				uHDR_addrHdr				 : 16;		\
					UINT32				uHDR_hdrSize				 : 16;		\
										}
	/* @'00004 */	union {	UINT32		u32DTCMBlk_HDR1;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DTCMBlk_drvrd (SIE_DTCMBlk *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DTCMBlk_drvwr (SIE_DTCMBlk *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DTCMBlk_cmp   (SIE_DTCMBlk *p, SIE_DTCMBlk *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DTCMBlk_import(SIE_DTCMBlk *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DTCMBlk_export(SIE_DTCMBlk *p, char *regs);
...
typedef struct SIE_DTCMBlkQ {
	...
	#define	w32DTCMBlkQ_HDR 			{										\
					UINT32				uHDR_nRdOff					 : 16;		\
					UINT32				uHDR_nWrOff					 : 16;		\
										}
	/* @'00000 */	union {	UINT32		u32DTCMBlkQ_HDR;
	...
	#define	w32DTCMBlkQ_HDR1 			{										\
					UINT32				uHDR_nTotalSize				 : 16;		\
					UINT32				uHDR_nMaxSize				 : 16;		\
										}
	/* @'00004 */	union {	UINT32		u32DTCMBlkQ_HDR1;
	...
	#define	w32DTCMBlkQ_LIST 			{										\
					UINT32				uLIST_blkPtrList_0i			 : 16;		\
					UINT32				uLIST_blkPtrList_1i			 : 16;		\
										}
	/* @'00008 */	union {	UINT32		u32DTCMBlkQ_LIST;
	...
	#define	w32DTCMBlkQ_LIST1 			{										\
					UINT32				uLIST_blkPtrList_2i			 : 16;		\
					UINT32				uLIST_blkPtrList_3i			 : 16;		\
										}
	/* @'0000C */	union {	UINT32		u32DTCMBlkQ_LIST1;
	...
	#define	w32DTCMBlkQ_LIST2 			{										\
					UINT32				uLIST_blkPtrList_4i			 : 16;		\
					UINT32				uLIST_blkPtrList_5i			 : 16;		\
										}
	/* @'00010 */	union {	UINT32		u32DTCMBlkQ_LIST2;
	...
	#define	w32DTCMBlkQ_LIST3 			{										\
					UINT32				uLIST_blkPtrList_6i			 : 16;		\
					UINT32				uLIST_blkPtrList_7i			 : 16;		\
										}
	/* @'00014 */	union {	UINT32		u32DTCMBlkQ_LIST3;
	...
	#define	w32DTCMBlkQ_LIST4 			{										\
					UINT32				uLIST_blkPtrList_8i			 : 16;		\
					UINT32				uLIST_blkPtrList_9i			 : 16;		\
										}
	/* @'00018 */	union {	UINT32		u32DTCMBlkQ_LIST4;
	...
	#define	w32DTCMBlkQ_LIST5 			{										\
					UINT32				uLIST_blkPtrList_10i		 : 16;		\
					UINT32				uLIST_blkPtrList_11i		 : 16;		\
										}
	/* @'0001C */	union {	UINT32		u32DTCMBlkQ_LIST5;
	...
	#define	w32DTCMBlkQ_LIST6 			{										\
					UINT32				uLIST_blkPtrList_12i		 : 16;		\
					UINT32				uLIST_blkPtrList_13i		 : 16;		\
										}
	/* @'00020 */	union {	UINT32		u32DTCMBlkQ_LIST6;
	...
	#define	w32DTCMBlkQ_LIST7 			{										\
					UINT32				uLIST_blkPtrList_14i		 : 16;		\
					UINT32				uLIST_blkPtrList_15i		 : 16;		\
										}
	/* @'00024 */	union {	UINT32		u32DTCMBlkQ_LIST7;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DTCMBlkQ_drvrd (SIE_DTCMBlkQ *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DTCMBlkQ_drvwr (SIE_DTCMBlkQ *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DTCMBlkQ_cmp   (SIE_DTCMBlkQ *p, SIE_DTCMBlkQ *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DTCMBlkQ_import(SIE_DTCMBlkQ *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DTCMBlkQ_export(SIE_DTCMBlkQ *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DTCMBlkPool_drvrd (SIE_DTCMBlkPool *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DTCMBlkPool_drvwr (SIE_DTCMBlkPool *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DTCMBlkPool_cmp   (SIE_DTCMBlkPool *p, SIE_DTCMBlkPool *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DTCMBlkPool_import(SIE_DTCMBlkPool *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DTCMBlkPool_export(SIE_DTCMBlkPool *p, char *regs);
...
typedef struct SIE_IOCtrlFlag {
	...
	#define	w32IOCtrlFlag_IOCTRL 		{										\
					UINT32				uIOCTRL_datFlag				 :  1;		\
					UINT32				uIOCTRL_opFlag				 :  3;		\
					UINT32				_x00000	: 28;							\
										}
	/* @'00000 */	union {	UINT32		u32IOCtrlFlag_IOCTRL;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	IOCtrlFlag_drvrd (SIE_IOCtrlFlag *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	IOCtrlFlag_drvwr (SIE_IOCtrlFlag *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	IOCtrlFlag_cmp   (SIE_IOCtrlFlag *p, SIE_IOCtrlFlag *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	IOCtrlFlag_import(SIE_IOCtrlFlag *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	IOCtrlFlag_export(SIE_IOCtrlFlag *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DSStreamIn_drvrd (SIE_DSStreamIn *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DSStreamIn_drvwr (SIE_DSStreamIn *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DSStreamIn_cmp   (SIE_DSStreamIn *p, SIE_DSStreamIn *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DSStreamIn_import(SIE_DSStreamIn *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DSStreamIn_export(SIE_DSStreamIn *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DSStreamOut_drvrd (SIE_DSStreamOut *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DSStreamOut_drvwr (SIE_DSStreamOut *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DSStreamOut_cmp   (SIE_DSStreamOut *p, SIE_DSStreamOut *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DSStreamOut_import(SIE_DSStreamOut *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DSStreamOut_export(SIE_DSStreamOut *p, char *regs);
...
typedef struct SIE_DSStreamOutModule {
	...
	#define	w32DSStreamOutModule_HDR 	{										\
					UINT32				uHDR_datBlkPool				 : 16;		\
					UINT32				uHDR_lastDatBlkPtr			 : 16;		\
										}
	/* @'00000 */	union {	UINT32		u32DSStreamOutModule_HDR;
	...
	#define	w32DSStreamOutModule_HDR1 	{										\
					UINT32				uHDR_lastDSOutOwner			 : 16;		\
					UINT32				uHDR_Reserved				 : 16;		\
										}
	/* @'00004 */	union {	UINT32		u32DSStreamOutModule_HDR1;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DSStreamOutModule_drvrd (SIE_DSStreamOutModule *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DSStreamOutModule_drvwr (SIE_DSStreamOutModule *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DSStreamOutModule_cmp   (SIE_DSStreamOutModule *p, SIE_DSStreamOutModule *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DSStreamOutModule_import(SIE_DSStreamOutModule *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DSStreamOutModule_export(SIE_DSStreamOutModule *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DSOutBlkReserved_drvrd (SIE_DSOutBlkReserved *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DSOutBlkReserved_drvwr (SIE_DSOutBlkReserved *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DSOutBlkReserved_cmp   (SIE_DSOutBlkReserved *p, SIE_DSOutBlkReserved *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DSOutBlkReserved_import(SIE_DSOutBlkReserved *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DSOutBlkReserved_export(SIE_DSOutBlkReserved *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DTCMStream_drvrd (SIE_DTCMStream *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DTCMStream_drvwr (SIE_DTCMStream *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DTCMStream_cmp   (SIE_DTCMStream *p, SIE_DTCMStream *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DTCMStream_import(SIE_DTCMStream *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DTCMStream_export(SIE_DTCMStream *p, char *regs);
...
typedef struct SIE_DSBlkRetEntry {
	...
	#define	w32DSBlkRetEntry_DAT 		{										\
					UINT32				uDAT_puAddr					 : 16;		\
					UINT32				uDAT_uValue					 : 16;		\
										}
	/* @'00000 */	union {	UINT32		u32DSBlkRetEntry_DAT;
	...
	#define	w32DSBlkRetEntry_DAT1 		{										\
					UINT32				uDAT_nDSCmdID				 : 16;		\
					UINT32				uDAT_nReserved				 : 16;		\
										}
	/* @'00004 */	union {	UINT32		u32DSBlkRetEntry_DAT1;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DSBlkRetEntry_drvrd (SIE_DSBlkRetEntry *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DSBlkRetEntry_drvwr (SIE_DSBlkRetEntry *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DSBlkRetEntry_cmp   (SIE_DSBlkRetEntry *p, SIE_DSBlkRetEntry *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DSBlkRetEntry_import(SIE_DSBlkRetEntry *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DSBlkRetEntry_export(SIE_DSBlkRetEntry *p, char *regs);
...
typedef struct SIE_DSBlkRetQ {
	...
	#define	w32DSBlkRetQ_HDR 			{										\
					UINT32				uHDR_nRdOffset				 : 16;		\
					UINT32				uHDR_nWrOffset				 : 16;		\
										}
	/* @'00000 */	union {	UINT32		u32DSBlkRetQ_HDR;
	...
	#define	w32DSBlkRetQ_HDR1 			{										\
					UINT32				uHDR_nReserved32			 : 32;		\
										}
	/* @'00004 */	union {	UINT32		u32DSBlkRetQ_HDR1;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DSBlkRetQ_drvrd (SIE_DSBlkRetQ *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DSBlkRetQ_drvwr (SIE_DSBlkRetQ *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DSBlkRetQ_cmp   (SIE_DSBlkRetQ *p, SIE_DSBlkRetQ *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DSBlkRetQ_import(SIE_DSBlkRetQ *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DSBlkRetQ_export(SIE_DSBlkRetQ *p, char *regs);
...
typedef struct SIE_StallCmd {
	...
	#define	w32StallCmd_CMD 			{										\
					UINT32				uCMD_cmdTag					 : 16;		\
					UINT32				_x00000	: 16;							\
										}
	/* @'00000 */	union {	UINT32		u32StallCmd_CMD;
	...
	#define	w32StallCmd_RSP 			{										\
					UINT32				uRSP_rspTag					 : 16;		\
					UINT32				_x00004	: 16;							\
										}
	/* @'00004 */	union {	UINT32		u32StallCmd_RSP;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	StallCmd_drvrd (SIE_StallCmd *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	StallCmd_drvwr (SIE_StallCmd *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	StallCmd_cmp   (SIE_StallCmd *p, SIE_StallCmd *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	StallCmd_import(SIE_StallCmd *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	StallCmd_export(SIE_StallCmd *p, char *regs);
...
typedef struct SIE_LocalArea {
	...
	#define	w32LocalArea_BRKCFG 		{										\
					UINT32				uBRKCFG_uDisableBreakPoint	 :  1;		\
					UINT32				_x0000C	: 31;							\
										}
	/* @'0000C */	union {	UINT32		u32LocalArea_BRKCFG;
	...
	#define	w32LocalArea_IMGBASE 		{										\
					UINT32				uIMGBASE_uDDRImgBase		 : 32;		\
										}
	/* @'001A0 */	union {	UINT32		u32LocalArea_IMGBASE;
	...
	#define	w32LocalArea_IMGBASE1 		{										\
					UINT32				uIMGBASE_uReserved			 : 32;		\
										}
	/* @'001A4 */	union {	UINT32		u32LocalArea_IMGBASE1;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	LocalArea_drvrd (SIE_LocalArea *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	LocalArea_drvwr (SIE_LocalArea *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	LocalArea_cmp   (SIE_LocalArea *p, SIE_LocalArea *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	LocalArea_import(SIE_LocalArea *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	LocalArea_export(SIE_LocalArea *p, char *regs);
...
typedef struct SIE_LACryptoCmdCnt {
	...
	#define	w32LACryptoCmdCnt_Local 	{										\
					UINT32				uLocal_uLocalCmdCnt			 : 32;		\
										}
	/* @'00000 */	union {	UINT32		u32LACryptoCmdCnt_Local;
	...
	#define	w32LACryptoCmdCnt_Local1 	{										\
					UINT32				uLocal_pad0					 : 32;		\
										}
	/* @'00004 */	union {	UINT32		u32LACryptoCmdCnt_Local1;
	...
	#define	w32LACryptoCmdCnt_RegSyn 	{										\
					UINT32				uRegSyn_uCryptoEngineUpdateCnt : 32;		\
										}
	/* @'00008 */	union {	UINT32		u32LACryptoCmdCnt_RegSyn;
	...
	#define	w32LACryptoCmdCnt_RegSyn1 	{										\
					UINT32				uRegSyn_pad1				 : 32;		\
										}
	/* @'0000C */	union {	UINT32		u32LACryptoCmdCnt_RegSyn1;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	LACryptoCmdCnt_drvrd (SIE_LACryptoCmdCnt *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	LACryptoCmdCnt_drvwr (SIE_LACryptoCmdCnt *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	LACryptoCmdCnt_cmp   (SIE_LACryptoCmdCnt *p, SIE_LACryptoCmdCnt *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	LACryptoCmdCnt_import(SIE_LACryptoCmdCnt *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	LACryptoCmdCnt_export(SIE_LACryptoCmdCnt *p, char *regs);
...
typedef struct SIE_LocalArea_Ext {
	...
	/* @'0000C */	union {	UINT32		u32LocalArea_Ext_BRKCFG;
	...
	/* @'001A0 */	union {	UINT32		u32LocalArea_Ext_IMGBASE;
	...
	/* @'001A4 */	union {	UINT32		u32LocalArea_Ext_IMGBASE1;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	LocalArea_Ext_drvrd (SIE_LocalArea_Ext *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	LocalArea_Ext_drvwr (SIE_LocalArea_Ext *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	LocalArea_Ext_cmp   (SIE_LocalArea_Ext *p, SIE_LocalArea_Ext *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	LocalArea_Ext_import(SIE_LocalArea_Ext *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	LocalArea_Ext_export(SIE_LocalArea_Ext *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	OTP_PRV_KEY_drvrd (SIE_OTP_PRV_KEY *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	OTP_PRV_KEY_drvwr (SIE_OTP_PRV_KEY *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	OTP_PRV_KEY_cmp   (SIE_OTP_PRV_KEY *p, SIE_OTP_PRV_KEY *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	OTP_PRV_KEY_import(SIE_OTP_PRV_KEY *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	OTP_PRV_KEY_export(SIE_OTP_PRV_KEY *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	OTP_CRC32_drvrd (SIE_OTP_CRC32 *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	OTP_CRC32_drvwr (SIE_OTP_CRC32 *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	OTP_CRC32_cmp   (SIE_OTP_CRC32 *p, SIE_OTP_CRC32 *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	OTP_CRC32_import(SIE_OTP_CRC32 *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	OTP_CRC32_export(SIE_OTP_CRC32 *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	BG2_OTP_CRC32_drvrd (SIE_BG2_OTP_CRC32 *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	BG2_OTP_CRC32_drvwr (SIE_BG2_OTP_CRC32 *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	BG2_OTP_CRC32_cmp   (SIE_BG2_OTP_CRC32 *p, SIE_BG2_OTP_CRC32 *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	BG2_OTP_CRC32_import(SIE_BG2_OTP_CRC32 *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	BG2_OTP_CRC32_export(SIE_BG2_OTP_CRC32 *p, char *regs);
...
typedef struct SIE_BG2_OTP_DAT {
	...
	#define	w32BG2_OTP_DAT_SIGNK_INFO 	{										\
					UINT32				uSIGNK_INFO_signkInfoHamming : 16;		\
					UINT32				uSIGNK_INFO_crc32Val0		 :  8;		\
					UINT32				uSIGNK_INFO_crc32Val1		 :  8;		\
										}
	/* @'00020 */	union {	UINT32		u32BG2_OTP_DAT_SIGNK_INFO;
	...
	#define	w32BG2_OTP_DAT_SIGNK_INFO1 	{										\
					UINT32				uSIGNK_INFO_crc32Val2		 :  8;		\
					UINT32				uSIGNK_INFO_crc32Val3		 :  8;		\
					UINT32				uSIGNK_INFO_otpKeyEnable	 :  8;		\
					UINT32				uSIGNK_INFO_reserved		 :  8;		\
										}
	/* @'00024 */	union {	UINT32		u32BG2_OTP_DAT_SIGNK_INFO1;
	...
	#define	w32BG2_OTP_DAT_RKEK_INFO 	{										\
					UINT32				uRKEK_INFO_rkekInfoHamming	 : 16;		\
					UINT32				uRKEK_INFO_crc32Val0		 :  8;		\
					UINT32				uRKEK_INFO_crc32Val1		 :  8;		\
										}
	/* @'000F0 */	union {	UINT32		u32BG2_OTP_DAT_RKEK_INFO;
	...
	#define	w32BG2_OTP_DAT_RKEK_INFO1 	{										\
					UINT32				uRKEK_INFO_crc32Val2		 :  8;		\
					UINT32				uRKEK_INFO_crc32Val3		 :  8;		\
					UINT32				uRKEK_INFO_reserved			 : 16;		\
										}
	/* @'000F4 */	union {	UINT32		u32BG2_OTP_DAT_RKEK_INFO1;
	...
	#define	w32BG2_OTP_DAT_MDK_INFO 	{										\
					UINT32				uMDK_INFO_mdkinfoHamming	 : 16;		\
					UINT32				uMDK_INFO_crc32Val0			 :  8;		\
					UINT32				uMDK_INFO_crc32Val1			 :  8;		\
										}
	/* @'00110 */	union {	UINT32		u32BG2_OTP_DAT_MDK_INFO;
	...
	#define	w32BG2_OTP_DAT_MDK_INFO1 	{										\
					UINT32				uMDK_INFO_crc32Val2			 :  8;		\
					UINT32				uMDK_INFO_crc32Val3			 :  8;		\
					UINT32				uMDK_INFO_mdkVersion		 : 16;		\
										}
	/* @'00114 */	union {	UINT32		u32BG2_OTP_DAT_MDK_INFO1;
	...
	#define	w32BG2_OTP_DAT_AESK_INFO 	{										\
					UINT32				uAESK_INFO_aeskInfoHamming	 : 16;		\
					UINT32				uAESK_INFO_crc32Val0		 :  8;		\
					UINT32				uAESK_INFO_crc32Val1		 :  8;		\
										}
	/* @'00148 */	union {	UINT32		u32BG2_OTP_DAT_AESK_INFO;
	...
	#define	w32BG2_OTP_DAT_AESK_INFO1 	{										\
					UINT32				uAESK_INFO_crc32Val2		 :  8;		\
					UINT32				uAESK_INFO_crc32Val3		 :  8;		\
					UINT32				uAESK_INFO_reserved			 : 16;		\
										}
	/* @'0014C */	union {	UINT32		u32BG2_OTP_DAT_AESK_INFO1;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	BG2_OTP_DAT_drvrd (SIE_BG2_OTP_DAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	BG2_OTP_DAT_drvwr (SIE_BG2_OTP_DAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	BG2_OTP_DAT_cmp   (SIE_BG2_OTP_DAT *p, SIE_BG2_OTP_DAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	BG2_OTP_DAT_import(SIE_BG2_OTP_DAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	BG2_OTP_DAT_export(SIE_BG2_OTP_DAT *p, char *regs);
...
typedef struct SIE_OTP_DAT {
	...
	#define	w32OTP_DAT_PRVK_INFO 		{										\
					UINT32				uPRVK_INFO_prvkInfoHamming	 :  8;		\
					UINT32				uPRVK_INFO_crc32Val0		 :  8;		\
					UINT32				uPRVK_INFO_crc32Val1		 :  8;		\
					UINT32				uPRVK_INFO_crc32Val2		 :  8;		\
										}
	/* @'00020 */	union {	UINT32		u32OTP_DAT_PRVK_INFO;
	...
	#define	w32OTP_DAT_PRVK_INFO1 		{										\
					UINT32				uPRVK_INFO_crc32Val3		 :  8;		\
					UINT32				uPRVK_INFO_prvkType			 :  8;		\
					UINT32				uPRVK_INFO_otpKeyEnable		 :  8;		\
					UINT32				uPRVK_INFO_reserved			 :  8;		\
										}
	/* @'00024 */	union {	UINT32		u32OTP_DAT_PRVK_INFO1;
	...
	#define	w32OTP_DAT_AESK_INFO 		{										\
					UINT32				uAESK_INFO_aeskInfoHamming	 :  8;		\
					UINT32				uAESK_INFO_crc32Val0		 :  8;		\
					UINT32				uAESK_INFO_crc32Val1		 :  8;		\
					UINT32				uAESK_INFO_crc32Val2		 :  8;		\
										}
	/* @'00100 */	union {	UINT32		u32OTP_DAT_AESK_INFO;
	...
	#define	w32OTP_DAT_AESK_INFO1 		{										\
					UINT32				uAESK_INFO_crc32Val3		 :  8;		\
					UINT32				uAESK_INFO_aeskType			 :  8;		\
					UINT32				uAESK_INFO_featureInfo1		 : 16;		\
										}
	/* @'00104 */	union {	UINT32		u32OTP_DAT_AESK_INFO1;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	OTP_DAT_drvrd (SIE_OTP_DAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	OTP_DAT_drvwr (SIE_OTP_DAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	OTP_DAT_cmp   (SIE_OTP_DAT *p, SIE_OTP_DAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	OTP_DAT_import(SIE_OTP_DAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	OTP_DAT_export(SIE_OTP_DAT *p, char *regs);
...
typedef struct SIE_OTP_STATUS {
	...
	#define	w32OTP_STATUS_DAT 			{										\
					UINT32				uDAT_rkek_status			 :  2;		\
					UINT32				uDAT_prvk_status			 :  2;		\
					UINT32				uDAT_aesk_status			 :  2;		\
					UINT32				_x00000	: 26;							\
										}
	/* @'00000 */	union {	UINT32		u32OTP_STATUS_DAT;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	OTP_STATUS_drvrd (SIE_OTP_STATUS *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	OTP_STATUS_drvwr (SIE_OTP_STATUS *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	OTP_STATUS_cmp   (SIE_OTP_STATUS *p, SIE_OTP_STATUS *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	OTP_STATUS_import(SIE_OTP_STATUS *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	OTP_STATUS_export(SIE_OTP_STATUS *p, char *regs);
...
typedef struct SIE_BG2_OTP_STATUS {
	...
	#define	w32BG2_OTP_STATUS_DAT 		{										\
					UINT32				uDAT_signk_status			 :  2;		\
					UINT32				uDAT_rkek_status			 :  2;		\
					UINT32				uDAT_aesk_status			 :  2;		\
					UINT32				uDAT_mdk_status				 :  2;		\
					UINT32				_x00000	: 24;							\
										}
	/* @'00000 */	union {	UINT32		u32BG2_OTP_STATUS_DAT;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	BG2_OTP_STATUS_drvrd (SIE_BG2_OTP_STATUS *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	BG2_OTP_STATUS_drvwr (SIE_BG2_OTP_STATUS *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	BG2_OTP_STATUS_cmp   (SIE_BG2_OTP_STATUS *p, SIE_BG2_OTP_STATUS *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	BG2_OTP_STATUS_import(SIE_BG2_OTP_STATUS *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	BG2_OTP_STATUS_export(SIE_BG2_OTP_STATUS *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	SECHF_ENTRY_drvrd (SIE_SECHF_ENTRY *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	SECHF_ENTRY_drvwr (SIE_SECHF_ENTRY *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	SECHF_ENTRY_cmp   (SIE_SECHF_ENTRY *p, SIE_SECHF_ENTRY *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	SECHF_ENTRY_import(SIE_SECHF_ENTRY *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	SECHF_ENTRY_export(SIE_SECHF_ENTRY *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	SECHF_drvrd (SIE_SECHF *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	SECHF_drvwr (SIE_SECHF *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	SECHF_cmp   (SIE_SECHF *p, SIE_SECHF *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	SECHF_import(SIE_SECHF *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	SECHF_export(SIE_SECHF *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	JTAGCTL_drvrd (SIE_JTAGCTL *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	JTAGCTL_drvwr (SIE_JTAGCTL *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	JTAGCTL_cmp   (SIE_JTAGCTL *p, SIE_JTAGCTL *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	JTAGCTL_import(SIE_JTAGCTL *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	JTAGCTL_export(SIE_JTAGCTL *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	REG64_drvrd (SIE_REG64 *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	REG64_drvwr (SIE_REG64 *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	REG64_cmp   (SIE_REG64 *p, SIE_REG64 *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	REG64_import(SIE_REG64 *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	REG64_export(SIE_REG64 *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	A64Par_drvrd (SIE_A64Par *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	A64Par_drvwr (SIE_A64Par *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	A64Par_cmp   (SIE_A64Par *p, SIE_A64Par *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	A64Par_import(SIE_A64Par *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	A64Par_export(SIE_A64Par *p, char *regs);
...
typedef struct SIE_K6 {
	...
	#define	w32K6_D0th_ 				{										\
					...
					UINT32				u_Re2						 :  1;		\
					UINT32				u_We						 :  1;		\
					UINT32				u_reserved1					 :  1;		\
					UINT32				u_reserved2					 :  1;		\
					UINT32				_x00000	: 26;							\
										}
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	K6_drvrd (SIE_K6 *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	K6_drvwr (SIE_K6 *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	K6_cmp   (SIE_K6 *p, SIE_K6 *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	K6_import(SIE_K6 *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	K6_export(SIE_K6 *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMPushID_drvrd (SIE_DRMPushID *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMPushID_drvwr (SIE_DRMPushID *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMPushID_cmp   (SIE_DRMPushID *p, SIE_DRMPushID *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMPushID_import(SIE_DRMPushID *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMPushID_export(SIE_DRMPushID *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	A64Entry_drvrd (SIE_A64Entry *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	A64Entry_drvwr (SIE_A64Entry *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	A64Entry_cmp   (SIE_A64Entry *p, SIE_A64Entry *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	A64Entry_import(SIE_A64Entry *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	A64Entry_export(SIE_A64Entry *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_CTXTYPE_drvrd (SIE_DRM_CTXTYPE *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_CTXTYPE_drvwr (SIE_DRM_CTXTYPE *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_CTXTYPE_cmp   (SIE_DRM_CTXTYPE *p, SIE_DRM_CTXTYPE *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_CTXTYPE_import(SIE_DRM_CTXTYPE *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_CTXTYPE_export(SIE_DRM_CTXTYPE *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_CTXHDR_drvrd (SIE_DRM_CTXHDR *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_CTXHDR_drvwr (SIE_DRM_CTXHDR *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_CTXHDR_cmp   (SIE_DRM_CTXHDR *p, SIE_DRM_CTXHDR *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_CTXHDR_import(SIE_DRM_CTXHDR *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_CTXHDR_export(SIE_DRM_CTXHDR *p, char *regs);
...
typedef struct SIE_DRM_SIGNTYPE {
	...
	#define	w32DRM_SIGNTYPE_DAT 		{										\
					UINT32				uDAT_typeID					 :  8;		\
					UINT32				_x00000	: 24;							\
										}
	/* @'00000 */	union {	UINT32		u32DRM_SIGNTYPE_DAT;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_SIGNTYPE_drvrd (SIE_DRM_SIGNTYPE *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_SIGNTYPE_drvwr (SIE_DRM_SIGNTYPE *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_SIGNTYPE_cmp   (SIE_DRM_SIGNTYPE *p, SIE_DRM_SIGNTYPE *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_SIGNTYPE_import(SIE_DRM_SIGNTYPE *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_SIGNTYPE_export(SIE_DRM_SIGNTYPE *p, char *regs);
...
typedef struct SIE_DRM_CTXID {
	...
	/* @'00000 */	union {	UINT32		u32DRM_CTXID_DAT;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_CTXID_drvrd (SIE_DRM_CTXID *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_CTXID_drvwr (SIE_DRM_CTXID *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_CTXID_cmp   (SIE_DRM_CTXID *p, SIE_DRM_CTXID *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_CTXID_import(SIE_DRM_CTXID *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_CTXID_export(SIE_DRM_CTXID *p, char *regs);
...
typedef struct SIE_DRM_BG2_CTXID {
	...
	/* @'00000 */	union {	UINT32		u32DRM_BG2_CTXID_DAT;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_BG2_CTXID_drvrd (SIE_DRM_BG2_CTXID *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_BG2_CTXID_drvwr (SIE_DRM_BG2_CTXID *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_BG2_CTXID_cmp   (SIE_DRM_BG2_CTXID *p, SIE_DRM_BG2_CTXID *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_BG2_CTXID_import(SIE_DRM_BG2_CTXID *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_BG2_CTXID_export(SIE_DRM_BG2_CTXID *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_KEYPARM_drvrd (SIE_DRM_KEYPARM *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_KEYPARM_drvwr (SIE_DRM_KEYPARM *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_KEYPARM_cmp   (SIE_DRM_KEYPARM *p, SIE_DRM_KEYPARM *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_KEYPARM_import(SIE_DRM_KEYPARM *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_KEYPARM_export(SIE_DRM_KEYPARM *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_KEYPARM_RSA_drvrd (SIE_DRM_KEYPARM_RSA *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_KEYPARM_RSA_drvwr (SIE_DRM_KEYPARM_RSA *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_KEYPARM_RSA_cmp   (SIE_DRM_KEYPARM_RSA *p, SIE_DRM_KEYPARM_RSA *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_KEYPARM_RSA_import(SIE_DRM_KEYPARM_RSA *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_KEYPARM_RSA_export(SIE_DRM_KEYPARM_RSA *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_KEYPARM_SYM_drvrd (SIE_DRM_KEYPARM_SYM *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_KEYPARM_SYM_drvwr (SIE_DRM_KEYPARM_SYM *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_KEYPARM_SYM_cmp   (SIE_DRM_KEYPARM_SYM *p, SIE_DRM_KEYPARM_SYM *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_KEYPARM_SYM_import(SIE_DRM_KEYPARM_SYM *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_KEYPARM_SYM_export(SIE_DRM_KEYPARM_SYM *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_DIGEST_drvrd (SIE_DRM_DIGEST *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_DIGEST_drvwr (SIE_DRM_DIGEST *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_DIGEST_cmp   (SIE_DRM_DIGEST *p, SIE_DRM_DIGEST *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_DIGEST_import(SIE_DRM_DIGEST *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_DIGEST_export(SIE_DRM_DIGEST *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_SUBKEY_OUT_drvrd (SIE_DRM_SUBKEY_OUT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_SUBKEY_OUT_drvwr (SIE_DRM_SUBKEY_OUT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_SUBKEY_OUT_cmp   (SIE_DRM_SUBKEY_OUT *p, SIE_DRM_SUBKEY_OUT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_SUBKEY_OUT_import(SIE_DRM_SUBKEY_OUT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_SUBKEY_OUT_export(SIE_DRM_SUBKEY_OUT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_KEYCTX_OUT_drvrd (SIE_DRM_KEYCTX_OUT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_KEYCTX_OUT_drvwr (SIE_DRM_KEYCTX_OUT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_KEYCTX_OUT_cmp   (SIE_DRM_KEYCTX_OUT *p, SIE_DRM_KEYCTX_OUT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_KEYCTX_OUT_import(SIE_DRM_KEYCTX_OUT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_KEYCTX_OUT_export(SIE_DRM_KEYCTX_OUT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_SYMKEYCTX256_IN_B_drvrd (SIE_DRM_SYMKEYCTX256_IN_B *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_SYMKEYCTX256_IN_B_drvwr (SIE_DRM_SYMKEYCTX256_IN_B *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_SYMKEYCTX256_IN_B_cmp   (SIE_DRM_SYMKEYCTX256_IN_B *p, SIE_DRM_SYMKEYCTX256_IN_B *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_SYMKEYCTX256_IN_B_import(SIE_DRM_SYMKEYCTX256_IN_B *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_SYMKEYCTX256_IN_B_export(SIE_DRM_SYMKEYCTX256_IN_B *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_SYMKEYCTX256_IN_drvrd (SIE_DRM_SYMKEYCTX256_IN *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_SYMKEYCTX256_IN_drvwr (SIE_DRM_SYMKEYCTX256_IN *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_SYMKEYCTX256_IN_cmp   (SIE_DRM_SYMKEYCTX256_IN *p, SIE_DRM_SYMKEYCTX256_IN *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_SYMKEYCTX256_IN_import(SIE_DRM_SYMKEYCTX256_IN *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_SYMKEYCTX256_IN_export(SIE_DRM_SYMKEYCTX256_IN *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_RSA1024_PUBKEY_drvrd (SIE_DRM_RSA1024_PUBKEY *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_RSA1024_PUBKEY_drvwr (SIE_DRM_RSA1024_PUBKEY *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_RSA1024_PUBKEY_cmp   (SIE_DRM_RSA1024_PUBKEY *p, SIE_DRM_RSA1024_PUBKEY *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_RSA1024_PUBKEY_import(SIE_DRM_RSA1024_PUBKEY *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_RSA1024_PUBKEY_export(SIE_DRM_RSA1024_PUBKEY *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_RSAKEYCTX1024_IN_drvrd (SIE_DRM_RSAKEYCTX1024_IN *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_RSAKEYCTX1024_IN_drvwr (SIE_DRM_RSAKEYCTX1024_IN *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_RSAKEYCTX1024_IN_cmp   (SIE_DRM_RSAKEYCTX1024_IN *p, SIE_DRM_RSAKEYCTX1024_IN *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_RSAKEYCTX1024_IN_import(SIE_DRM_RSAKEYCTX1024_IN *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_RSAKEYCTX1024_IN_export(SIE_DRM_RSAKEYCTX1024_IN *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_RSAKEYCTX1024_IN_B_drvrd (SIE_DRM_RSAKEYCTX1024_IN_B *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_RSAKEYCTX1024_IN_B_drvwr (SIE_DRM_RSAKEYCTX1024_IN_B *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_RSAKEYCTX1024_IN_B_cmp   (SIE_DRM_RSAKEYCTX1024_IN_B *p, SIE_DRM_RSAKEYCTX1024_IN_B *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_RSAKEYCTX1024_IN_B_import(SIE_DRM_RSAKEYCTX1024_IN_B *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_RSAKEYCTX1024_IN_B_export(SIE_DRM_RSAKEYCTX1024_IN_B *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_HASH_CTXIN_drvrd (SIE_DRM_HASH_CTXIN *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_HASH_CTXIN_drvwr (SIE_DRM_HASH_CTXIN *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_HASH_CTXIN_cmp   (SIE_DRM_HASH_CTXIN *p, SIE_DRM_HASH_CTXIN *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_HASH_CTXIN_import(SIE_DRM_HASH_CTXIN *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_HASH_CTXIN_export(SIE_DRM_HASH_CTXIN *p, char *regs);
...
typedef struct SIE_DRM_FIGOIMG {
	...
	#define	w32DRM_FIGOIMG_INFO 		{										\
					UINT32				uINFO_insNum				 : 16;		\
					UINT32				uINFO_insPCoff				 : 16;		\
										}
	/* @'00070 */	union {	UINT32		u32DRM_FIGOIMG_INFO;
	...
	#define	w32DRM_FIGOIMG_INFO1 		{										\
					UINT32				uINFO_datCnt				 : 16;		\
					UINT32				uINFO_datCntOff				 : 16;		\
										}
	/* @'00074 */	union {	UINT32		u32DRM_FIGOIMG_INFO1;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_FIGOIMG_drvrd (SIE_DRM_FIGOIMG *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_FIGOIMG_drvwr (SIE_DRM_FIGOIMG *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_FIGOIMG_cmp   (SIE_DRM_FIGOIMG *p, SIE_DRM_FIGOIMG *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_FIGOIMG_import(SIE_DRM_FIGOIMG *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_FIGOIMG_export(SIE_DRM_FIGOIMG *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_ARMIMG_drvrd (SIE_DRM_ARMIMG *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_ARMIMG_drvwr (SIE_DRM_ARMIMG *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_ARMIMG_cmp   (SIE_DRM_ARMIMG *p, SIE_DRM_ARMIMG *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_ARMIMG_import(SIE_DRM_ARMIMG *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_ARMIMG_export(SIE_DRM_ARMIMG *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	SHA1_RODAT_drvrd (SIE_SHA1_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	SHA1_RODAT_drvwr (SIE_SHA1_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	SHA1_RODAT_cmp   (SIE_SHA1_RODAT *p, SIE_SHA1_RODAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	SHA1_RODAT_import(SIE_SHA1_RODAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	SHA1_RODAT_export(SIE_SHA1_RODAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	SHA1_CTXDAT_drvrd (SIE_SHA1_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	SHA1_CTXDAT_drvwr (SIE_SHA1_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	SHA1_CTXDAT_cmp   (SIE_SHA1_CTXDAT *p, SIE_SHA1_CTXDAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	SHA1_CTXDAT_import(SIE_SHA1_CTXDAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	SHA1_CTXDAT_export(SIE_SHA1_CTXDAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	CRC32_RODAT_drvrd (SIE_CRC32_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	CRC32_RODAT_drvwr (SIE_CRC32_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	CRC32_RODAT_cmp   (SIE_CRC32_RODAT *p, SIE_CRC32_RODAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	CRC32_RODAT_import(SIE_CRC32_RODAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	CRC32_RODAT_export(SIE_CRC32_RODAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	AESWRAP_RODAT_drvrd (SIE_AESWRAP_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	AESWRAP_RODAT_drvwr (SIE_AESWRAP_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	AESWRAP_RODAT_cmp   (SIE_AESWRAP_RODAT *p, SIE_AESWRAP_RODAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	AESWRAP_RODAT_import(SIE_AESWRAP_RODAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	AESWRAP_RODAT_export(SIE_AESWRAP_RODAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	AESWRAP_CTX_drvrd (SIE_AESWRAP_CTX *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	AESWRAP_CTX_drvwr (SIE_AESWRAP_CTX *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	AESWRAP_CTX_cmp   (SIE_AESWRAP_CTX *p, SIE_AESWRAP_CTX *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	AESWRAP_CTX_import(SIE_AESWRAP_CTX *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	AESWRAP_CTX_export(SIE_AESWRAP_CTX *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	HMAC_RODAT_drvrd (SIE_HMAC_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	HMAC_RODAT_drvwr (SIE_HMAC_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	HMAC_RODAT_cmp   (SIE_HMAC_RODAT *p, SIE_HMAC_RODAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	HMAC_RODAT_import(SIE_HMAC_RODAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	HMAC_RODAT_export(SIE_HMAC_RODAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	HMAC_CTXDAT_drvrd (SIE_HMAC_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	HMAC_CTXDAT_drvwr (SIE_HMAC_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	HMAC_CTXDAT_cmp   (SIE_HMAC_CTXDAT *p, SIE_HMAC_CTXDAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	HMAC_CTXDAT_import(SIE_HMAC_CTXDAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	HMAC_CTXDAT_export(SIE_HMAC_CTXDAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	CMAC_RODAT_drvrd (SIE_CMAC_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	CMAC_RODAT_drvwr (SIE_CMAC_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	CMAC_RODAT_cmp   (SIE_CMAC_RODAT *p, SIE_CMAC_RODAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	CMAC_RODAT_import(SIE_CMAC_RODAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	CMAC_RODAT_export(SIE_CMAC_RODAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	CMAC_CTXDAT_drvrd (SIE_CMAC_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	CMAC_CTXDAT_drvwr (SIE_CMAC_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	CMAC_CTXDAT_cmp   (SIE_CMAC_CTXDAT *p, SIE_CMAC_CTXDAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	CMAC_CTXDAT_import(SIE_CMAC_CTXDAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	CMAC_CTXDAT_export(SIE_CMAC_CTXDAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	AES128_RODAT_drvrd (SIE_AES128_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	AES128_RODAT_drvwr (SIE_AES128_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	AES128_RODAT_cmp   (SIE_AES128_RODAT *p, SIE_AES128_RODAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	AES128_RODAT_import(SIE_AES128_RODAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	AES128_RODAT_export(SIE_AES128_RODAT *p, char *regs);
...
typedef struct SIE_AES128_CTXDAT {
	...
	#define	w32AES128_CTXDAT_TB_OFF 	{										\
					UINT32				uTB_OFF_pbSbox				 : 16;		\
					UINT32				uTB_OFF_pbiSbox				 : 16;		\
										}
	/* @'00610 */	union {	UINT32		u32AES128_CTXDAT_TB_OFF;
	...
	#define	w32AES128_CTXDAT_TB_OFF1 	{										\
					UINT32				uTB_OFF_pbRecon				 : 16;		\
					UINT32				_x00614	: 16;							\
										}
	/* @'00614 */	union {	UINT32		u32AES128_CTXDAT_TB_OFF1;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	AES128_CTXDAT_drvrd (SIE_AES128_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	AES128_CTXDAT_drvwr (SIE_AES128_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	AES128_CTXDAT_cmp   (SIE_AES128_CTXDAT *p, SIE_AES128_CTXDAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	AES128_CTXDAT_import(SIE_AES128_CTXDAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	AES128_CTXDAT_export(SIE_AES128_CTXDAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	HAMMING_INVALID_ENTRY_drvrd (SIE_HAMMING_INVALID_ENTRY *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	HAMMING_INVALID_ENTRY_drvwr (SIE_HAMMING_INVALID_ENTRY *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	HAMMING_INVALID_ENTRY_cmp   (SIE_HAMMING_INVALID_ENTRY *p, SIE_HAMMING_INVALID_ENTRY *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	HAMMING_INVALID_ENTRY_import(SIE_HAMMING_INVALID_ENTRY *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	HAMMING_INVALID_ENTRY_export(SIE_HAMMING_INVALID_ENTRY *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	OFFTB_ENTRY_drvrd (SIE_OFFTB_ENTRY *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	OFFTB_ENTRY_drvwr (SIE_OFFTB_ENTRY *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	OFFTB_ENTRY_cmp   (SIE_OFFTB_ENTRY *p, SIE_OFFTB_ENTRY *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	OFFTB_ENTRY_import(SIE_OFFTB_ENTRY *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	OFFTB_ENTRY_export(SIE_OFFTB_ENTRY *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	HAMMING_RODAT_drvrd (SIE_HAMMING_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	HAMMING_RODAT_drvwr (SIE_HAMMING_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	HAMMING_RODAT_cmp   (SIE_HAMMING_RODAT *p, SIE_HAMMING_RODAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	HAMMING_RODAT_import(SIE_HAMMING_RODAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	HAMMING_RODAT_export(SIE_HAMMING_RODAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DES3_RODAT_drvrd (SIE_DES3_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DES3_RODAT_drvwr (SIE_DES3_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DES3_RODAT_cmp   (SIE_DES3_RODAT *p, SIE_DES3_RODAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DES3_RODAT_import(SIE_DES3_RODAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DES3_RODAT_export(SIE_DES3_RODAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DES3_CTXDAT_drvrd (SIE_DES3_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DES3_CTXDAT_drvwr (SIE_DES3_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DES3_CTXDAT_cmp   (SIE_DES3_CTXDAT *p, SIE_DES3_CTXDAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DES3_CTXDAT_import(SIE_DES3_CTXDAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DES3_CTXDAT_export(SIE_DES3_CTXDAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DES_CTXDAT_drvrd (SIE_DES_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DES_CTXDAT_drvwr (SIE_DES_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DES_CTXDAT_cmp   (SIE_DES_CTXDAT *p, SIE_DES_CTXDAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DES_CTXDAT_import(SIE_DES_CTXDAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DES_CTXDAT_export(SIE_DES_CTXDAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	MULT2_RODAT_drvrd (SIE_MULT2_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	MULT2_RODAT_drvwr (SIE_MULT2_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	MULT2_RODAT_cmp   (SIE_MULT2_RODAT *p, SIE_MULT2_RODAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	MULT2_RODAT_import(SIE_MULT2_RODAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	MULT2_RODAT_export(SIE_MULT2_RODAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	MULT2_CTXDAT_drvrd (SIE_MULT2_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	MULT2_CTXDAT_drvwr (SIE_MULT2_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	MULT2_CTXDAT_cmp   (SIE_MULT2_CTXDAT *p, SIE_MULT2_CTXDAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	MULT2_CTXDAT_import(SIE_MULT2_CTXDAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	MULT2_CTXDAT_export(SIE_MULT2_CTXDAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	C2_RODAT_drvrd (SIE_C2_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	C2_RODAT_drvwr (SIE_C2_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	C2_RODAT_cmp   (SIE_C2_RODAT *p, SIE_C2_RODAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	C2_RODAT_import(SIE_C2_RODAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	C2_RODAT_export(SIE_C2_RODAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	C2_CTXDAT_drvrd (SIE_C2_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	C2_CTXDAT_drvwr (SIE_C2_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	C2_CTXDAT_cmp   (SIE_C2_CTXDAT *p, SIE_C2_CTXDAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	C2_CTXDAT_import(SIE_C2_CTXDAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	C2_CTXDAT_export(SIE_C2_CTXDAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	PSS_CTXDAT_drvrd (SIE_PSS_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	PSS_CTXDAT_drvwr (SIE_PSS_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	PSS_CTXDAT_cmp   (SIE_PSS_CTXDAT *p, SIE_PSS_CTXDAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	PSS_CTXDAT_import(SIE_PSS_CTXDAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	PSS_CTXDAT_export(SIE_PSS_CTXDAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	RSA_RODAT_drvrd (SIE_RSA_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	RSA_RODAT_drvwr (SIE_RSA_RODAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	RSA_RODAT_cmp   (SIE_RSA_RODAT *p, SIE_RSA_RODAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	RSA_RODAT_import(SIE_RSA_RODAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	RSA_RODAT_export(SIE_RSA_RODAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	RSA_CTXDAT_drvrd (SIE_RSA_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	RSA_CTXDAT_drvwr (SIE_RSA_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	RSA_CTXDAT_cmp   (SIE_RSA_CTXDAT *p, SIE_RSA_CTXDAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	RSA_CTXDAT_import(SIE_RSA_CTXDAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	RSA_CTXDAT_export(SIE_RSA_CTXDAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	CBCMAC_CTXDAT_drvrd (SIE_CBCMAC_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	CBCMAC_CTXDAT_drvwr (SIE_CBCMAC_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	CBCMAC_CTXDAT_cmp   (SIE_CBCMAC_CTXDAT *p, SIE_CBCMAC_CTXDAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	CBCMAC_CTXDAT_import(SIE_CBCMAC_CTXDAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	CBCMAC_CTXDAT_export(SIE_CBCMAC_CTXDAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	RC4_CTXDAT_drvrd (SIE_RC4_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	RC4_CTXDAT_drvwr (SIE_RC4_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	RC4_CTXDAT_cmp   (SIE_RC4_CTXDAT *p, SIE_RC4_CTXDAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	RC4_CTXDAT_import(SIE_RC4_CTXDAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	RC4_CTXDAT_export(SIE_RC4_CTXDAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	MD5_CTXDAT_drvrd (SIE_MD5_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	MD5_CTXDAT_drvwr (SIE_MD5_CTXDAT *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	MD5_CTXDAT_cmp   (SIE_MD5_CTXDAT *p, SIE_MD5_CTXDAT *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	MD5_CTXDAT_import(SIE_MD5_CTXDAT *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	MD5_CTXDAT_export(SIE_MD5_CTXDAT *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMROM_CMD_TYPE_drvrd (SIE_DRMROM_CMD_TYPE *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMROM_CMD_TYPE_drvwr (SIE_DRMROM_CMD_TYPE *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMROM_CMD_TYPE_cmp   (SIE_DRMROM_CMD_TYPE *p, SIE_DRMROM_CMD_TYPE *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMROM_CMD_TYPE_import(SIE_DRMROM_CMD_TYPE *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMROM_CMD_TYPE_export(SIE_DRMROM_CMD_TYPE *p, char *regs);
...
typedef struct SIE_DRMROM_CMD {
	...
	/* @'00000 */	union {	UINT32		u32DRMROM_CMD_STAT;
	...
	#define	w32DRMROM_CMD_CMD_CFG 		{										\
					UINT32				uCMD_CFG_tag				 :  8;		\
					UINT32				uCMD_CFG_subKeyID			 :  8;		\
					UINT32				uCMD_CFG_nonce				 : 16;		\
										}
	/* @'00004 */	union {	UINT32		u32DRMROM_CMD_CMD_CFG;
	...
	#define	w32DRMROM_CMD_CMD_DAT0 		{										\
					UINT32				uCMD_DAT0_crcCmd32			 : 32;		\
										}
	/* @'00008 */	union {	UINT32		u32DRMROM_CMD_CMD_DAT0;
	...
	#define	w32DRMROM_CMD_CMD_DAT1 		{										\
					UINT32				uCMD_DAT1_imgSz				 : 32;		\
										}
	/* @'0000C */	union {	UINT32		u32DRMROM_CMD_CMD_DAT1;
	...
	#define	w32DRMROM_CMD_CMD_DAT2 		{										\
					UINT32				uCMD_DAT2_imgSrcAddr		 : 32;		\
										}
	/* @'00010 */	union {	UINT32		u32DRMROM_CMD_CMD_DAT2;
	...
	#define	w32DRMROM_CMD_CMD_DAT3 		{										\
					UINT32				uCMD_DAT3_imgDstAddr		 : 32;		\
										}
	/* @'00014 */	union {	UINT32		u32DRMROM_CMD_CMD_DAT3;
	...
	#define	w32DRMROM_CMD_RSP_CFG 		{										\
					UINT32				uRSP_CFG_tag				 :  8;		\
					UINT32				_x00018	: 24;							\
										}
	/* @'00018 */	union {	UINT32		u32DRMROM_CMD_RSP_CFG;
	...
	#define	w32DRMROM_CMD_RSP_DAT0 		{										\
					UINT32				uRSP_DAT0_crcRsp32			 : 32;		\
										}
	/* @'0001C */	union {	UINT32		u32DRMROM_CMD_RSP_DAT0;
	...
	#define	w32DRMROM_CMD_RSP_DAT1 		{										\
					UINT32				uRSP_DAT1_error				 : 32;		\
										}
	/* @'00020 */	union {	UINT32		u32DRMROM_CMD_RSP_DAT1;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMROM_CMD_drvrd (SIE_DRMROM_CMD *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMROM_CMD_drvwr (SIE_DRMROM_CMD *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMROM_CMD_cmp   (SIE_DRMROM_CMD *p, SIE_DRMROM_CMD *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMROM_CMD_import(SIE_DRMROM_CMD *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMROM_CMD_export(SIE_DRMROM_CMD *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_DROM_drvrd (SIE_DRM_DROM *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_DROM_drvwr (SIE_DRM_DROM *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_DROM_cmp   (SIE_DRM_DROM *p, SIE_DRM_DROM *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_DROM_import(SIE_DRM_DROM *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_DROM_export(SIE_DRM_DROM *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMROM_FIFOIDX_drvrd (SIE_DRMROM_FIFOIDX *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMROM_FIFOIDX_drvwr (SIE_DRMROM_FIFOIDX *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMROM_FIFOIDX_cmp   (SIE_DRMROM_FIFOIDX *p, SIE_DRMROM_FIFOIDX *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMROM_FIFOIDX_import(SIE_DRMROM_FIFOIDX *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMROM_FIFOIDX_export(SIE_DRMROM_FIFOIDX *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMROM_SRAM_RESERVED_drvrd (SIE_DRMROM_SRAM_RESERVED *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMROM_SRAM_RESERVED_drvwr (SIE_DRMROM_SRAM_RESERVED *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMROM_SRAM_RESERVED_cmp   (SIE_DRMROM_SRAM_RESERVED *p, SIE_DRMROM_SRAM_RESERVED *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMROM_SRAM_RESERVED_import(SIE_DRMROM_SRAM_RESERVED *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMROM_SRAM_RESERVED_export(SIE_DRMROM_SRAM_RESERVED *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	USERKEY_CTX_drvrd (SIE_USERKEY_CTX *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	USERKEY_CTX_drvwr (SIE_USERKEY_CTX *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	USERKEY_CTX_cmp   (SIE_USERKEY_CTX *p, SIE_USERKEY_CTX *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	USERKEY_CTX_import(SIE_USERKEY_CTX *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	USERKEY_CTX_export(SIE_USERKEY_CTX *p, char *regs);
...
typedef struct SIE_USERKEY_MAGICNUM {
	...
	/* @'00000 */	union {	UINT32		u32USERKEY_MAGICNUM_DAT;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	USERKEY_MAGICNUM_drvrd (SIE_USERKEY_MAGICNUM *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	USERKEY_MAGICNUM_drvwr (SIE_USERKEY_MAGICNUM *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	USERKEY_MAGICNUM_cmp   (SIE_USERKEY_MAGICNUM *p, SIE_USERKEY_MAGICNUM *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	USERKEY_MAGICNUM_import(SIE_USERKEY_MAGICNUM *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	USERKEY_MAGICNUM_export(SIE_USERKEY_MAGICNUM *p, char *regs);
...
typedef struct SIE_DRMROM_SRAM {
	...
	#define	w32DRMROM_SRAM_SEC_BITS 	{										\
					UINT32				uSEC_BITS_prvkSecBits0		 : 16;		\
					UINT32				uSEC_BITS_prvkSecBits1		 : 16;		\
										}
	/* @'007F0 */	union {	UINT32		u32DRMROM_SRAM_SEC_BITS;
	...
	#define	w32DRMROM_SRAM_SEC_BITS1 	{										\
					UINT32				uSEC_BITS_prvkSecBits2		 : 16;		\
					UINT32				uSEC_BITS_rkekSecBits		 : 16;		\
										}
	/* @'007F4 */	union {	UINT32		u32DRMROM_SRAM_SEC_BITS1;
	...
	#define	w32DRMROM_SRAM_SEC_BITS2 	{										\
					UINT32				uSEC_BITS_aeskSecBits		 : 16;		\
					UINT32				_x007F8	: 16;							\
										}
	/* @'007F8 */	union {	UINT32		u32DRMROM_SRAM_SEC_BITS2;
	...
	UINT32	_PAD_000[(0x00FF0-0x00EE0)/4];
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMROM_SRAM_drvrd (SIE_DRMROM_SRAM *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMROM_SRAM_drvwr (SIE_DRMROM_SRAM *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMROM_SRAM_cmp   (SIE_DRMROM_SRAM *p, SIE_DRMROM_SRAM *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMROM_SRAM_import(SIE_DRMROM_SRAM *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMROM_SRAM_export(SIE_DRMROM_SRAM *p, char *regs);
...
typedef struct SIE_DRM_CMD {
	...
	#define	w32DRM_CMD_CMD 				{										\
					UINT32				uCMD_tag					 :  8;		\
					UINT32				uCMD_nonce					 : 24;		\
										}
	/* @'00000 */	union {	UINT32		u32DRM_CMD_CMD;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_CMD_drvrd (SIE_DRM_CMD *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_CMD_drvwr (SIE_DRM_CMD *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_CMD_cmp   (SIE_DRM_CMD *p, SIE_DRM_CMD *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_CMD_import(SIE_DRM_CMD *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_CMD_export(SIE_DRM_CMD *p, char *regs);
...
typedef struct SIE_DRM_RSP {
	...
	/* @'00000 */	union {	UINT32		u32DRM_RSP_RSP;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_RSP_drvrd (SIE_DRM_RSP *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_RSP_drvwr (SIE_DRM_RSP *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_RSP_cmp   (SIE_DRM_RSP *p, SIE_DRM_RSP *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_RSP_import(SIE_DRM_RSP *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_RSP_export(SIE_DRM_RSP *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMCMD_HASH_drvrd (SIE_DRMCMD_HASH *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMCMD_HASH_drvwr (SIE_DRMCMD_HASH *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMCMD_HASH_cmp   (SIE_DRMCMD_HASH *p, SIE_DRMCMD_HASH *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMCMD_HASH_import(SIE_DRMCMD_HASH *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMCMD_HASH_export(SIE_DRMCMD_HASH *p, char *regs);
...
typedef struct SIE_DRMCMD_KEY_ENCDEC {
	...
	#define	w32DRMCMD_KEY_ENCDEC_D4th_ 	{										\
					UINT32				u_isSRAMAddr				 :  1;		\
					UINT32				u_datDstAddr				 : 31;		\
										}
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMCMD_KEY_ENCDEC_drvrd (SIE_DRMCMD_KEY_ENCDEC *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMCMD_KEY_ENCDEC_drvwr (SIE_DRMCMD_KEY_ENCDEC *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMCMD_KEY_ENCDEC_cmp   (SIE_DRMCMD_KEY_ENCDEC *p, SIE_DRMCMD_KEY_ENCDEC *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMCMD_KEY_ENCDEC_import(SIE_DRMCMD_KEY_ENCDEC *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMCMD_KEY_ENCDEC_export(SIE_DRMCMD_KEY_ENCDEC *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMCMD_KEY_TRANS_drvrd (SIE_DRMCMD_KEY_TRANS *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMCMD_KEY_TRANS_drvwr (SIE_DRMCMD_KEY_TRANS *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMCMD_KEY_TRANS_cmp   (SIE_DRMCMD_KEY_TRANS *p, SIE_DRMCMD_KEY_TRANS *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMCMD_KEY_TRANS_import(SIE_DRMCMD_KEY_TRANS *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMCMD_KEY_TRANS_export(SIE_DRMCMD_KEY_TRANS *p, char *regs);
...
typedef struct SIE_CRYPTO_ENGINE_CONST {
	...
	/* @'00000 */	union {	UINT32		u32CRYPTO_ENGINE_CONST_CMD;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	CRYPTO_ENGINE_CONST_drvrd (SIE_CRYPTO_ENGINE_CONST *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	CRYPTO_ENGINE_CONST_drvwr (SIE_CRYPTO_ENGINE_CONST *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	CRYPTO_ENGINE_CONST_cmp   (SIE_CRYPTO_ENGINE_CONST *p, SIE_CRYPTO_ENGINE_CONST *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	CRYPTO_ENGINE_CONST_import(SIE_CRYPTO_ENGINE_CONST *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	CRYPTO_ENGINE_CONST_export(SIE_CRYPTO_ENGINE_CONST *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	SPHAL_CMD_HASH_drvrd (SIE_SPHAL_CMD_HASH *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	SPHAL_CMD_HASH_drvwr (SIE_SPHAL_CMD_HASH *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	SPHAL_CMD_HASH_cmp   (SIE_SPHAL_CMD_HASH *p, SIE_SPHAL_CMD_HASH *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	SPHAL_CMD_HASH_import(SIE_SPHAL_CMD_HASH *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	SPHAL_CMD_HASH_export(SIE_SPHAL_CMD_HASH *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	SPHAL_CMD_ENCDEC_drvrd (SIE_SPHAL_CMD_ENCDEC *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	SPHAL_CMD_ENCDEC_drvwr (SIE_SPHAL_CMD_ENCDEC *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	SPHAL_CMD_ENCDEC_cmp   (SIE_SPHAL_CMD_ENCDEC *p, SIE_SPHAL_CMD_ENCDEC *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	SPHAL_CMD_ENCDEC_import(SIE_SPHAL_CMD_ENCDEC *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	SPHAL_CMD_ENCDEC_export(SIE_SPHAL_CMD_ENCDEC *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	SPHAL_CMD_RNG_drvrd (SIE_SPHAL_CMD_RNG *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	SPHAL_CMD_RNG_drvwr (SIE_SPHAL_CMD_RNG *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	SPHAL_CMD_RNG_cmp   (SIE_SPHAL_CMD_RNG *p, SIE_SPHAL_CMD_RNG *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	SPHAL_CMD_RNG_import(SIE_SPHAL_CMD_RNG *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	SPHAL_CMD_RNG_export(SIE_SPHAL_CMD_RNG *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	SPHAL_CMD_RC4_drvrd (SIE_SPHAL_CMD_RC4 *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	SPHAL_CMD_RC4_drvwr (SIE_SPHAL_CMD_RC4 *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	SPHAL_CMD_RC4_cmp   (SIE_SPHAL_CMD_RC4 *p, SIE_SPHAL_CMD_RC4 *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	SPHAL_CMD_RC4_import(SIE_SPHAL_CMD_RC4 *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	SPHAL_CMD_RC4_export(SIE_SPHAL_CMD_RC4 *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	OTP_INFO_CTX_drvrd (SIE_OTP_INFO_CTX *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	OTP_INFO_CTX_drvwr (SIE_OTP_INFO_CTX *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	OTP_INFO_CTX_cmp   (SIE_OTP_INFO_CTX *p, SIE_OTP_INFO_CTX *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	OTP_INFO_CTX_import(SIE_OTP_INFO_CTX *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	OTP_INFO_CTX_export(SIE_OTP_INFO_CTX *p, char *regs);
...
typedef struct SIE_CRYPTO_ENGINE_CTX {
	...
	#define	w32CRYPTO_ENGINE_CTX_D1th_ 	{										\
					UINT32				u_engineType				 :  8;		\
					UINT32				u_mode						 :  8;		\
					UINT32				u_isKeyReady				 :  8;		\
					UINT32				u_keyId						 :  8;		\
										}
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	CRYPTO_ENGINE_CTX_drvrd (SIE_CRYPTO_ENGINE_CTX *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	CRYPTO_ENGINE_CTX_drvwr (SIE_CRYPTO_ENGINE_CTX *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	CRYPTO_ENGINE_CTX_cmp   (SIE_CRYPTO_ENGINE_CTX *p, SIE_CRYPTO_ENGINE_CTX *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	CRYPTO_ENGINE_CTX_import(SIE_CRYPTO_ENGINE_CTX *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	CRYPTO_ENGINE_CTX_export(SIE_CRYPTO_ENGINE_CTX *p, char *regs);
...
typedef struct SIE_DRMDiagCryptoEngineCtx {
	...
	UINT32	_PAD_000[(0x01000-0x002D0)/4];
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMDiagCryptoEngineCtx_drvrd (SIE_DRMDiagCryptoEngineCtx *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMDiagCryptoEngineCtx_drvwr (SIE_DRMDiagCryptoEngineCtx *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMDiagCryptoEngineCtx_cmp   (SIE_DRMDiagCryptoEngineCtx *p, SIE_DRMDiagCryptoEngineCtx *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMDiagCryptoEngineCtx_import(SIE_DRMDiagCryptoEngineCtx *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMDiagCryptoEngineCtx_export(SIE_DRMDiagCryptoEngineCtx *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMCONST_drvrd (SIE_DRMCONST *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMCONST_drvwr (SIE_DRMCONST *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMCONST_cmp   (SIE_DRMCONST *p, SIE_DRMCONST *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMCONST_import(SIE_DRMCONST *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMCONST_export(SIE_DRMCONST *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	WrapperTK_drvrd (SIE_WrapperTK *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	WrapperTK_drvwr (SIE_WrapperTK *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	WrapperTK_cmp   (SIE_WrapperTK *p, SIE_WrapperTK *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	WrapperTK_import(SIE_WrapperTK *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	WrapperTK_export(SIE_WrapperTK *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	FIGOCTRLUpdateTK_drvrd (SIE_FIGOCTRLUpdateTK *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	FIGOCTRLUpdateTK_drvwr (SIE_FIGOCTRLUpdateTK *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	FIGOCTRLUpdateTK_cmp   (SIE_FIGOCTRLUpdateTK *p, SIE_FIGOCTRLUpdateTK *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	FIGOCTRLUpdateTK_import(SIE_FIGOCTRLUpdateTK *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	FIGOCTRLUpdateTK_export(SIE_FIGOCTRLUpdateTK *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	FIGOCTRLUpdateBK_drvrd (SIE_FIGOCTRLUpdateBK *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	FIGOCTRLUpdateBK_drvwr (SIE_FIGOCTRLUpdateBK *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	FIGOCTRLUpdateBK_cmp   (SIE_FIGOCTRLUpdateBK *p, SIE_FIGOCTRLUpdateBK *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	FIGOCTRLUpdateBK_import(SIE_FIGOCTRLUpdateBK *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	FIGOCTRLUpdateBK_export(SIE_FIGOCTRLUpdateBK *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	KeySeed_drvrd (SIE_KeySeed *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	KeySeed_drvwr (SIE_KeySeed *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	KeySeed_cmp   (SIE_KeySeed *p, SIE_KeySeed *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	KeySeed_import(SIE_KeySeed *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	KeySeed_export(SIE_KeySeed *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	BusKeyCtx_drvrd (SIE_BusKeyCtx *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	BusKeyCtx_drvwr (SIE_BusKeyCtx *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	BusKeyCtx_cmp   (SIE_BusKeyCtx *p, SIE_BusKeyCtx *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	BusKeyCtx_import(SIE_BusKeyCtx *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	BusKeyCtx_export(SIE_BusKeyCtx *p, char *regs);
...
typedef struct SIE_DRMBDFilter {
	...
	#define	w32DRMBDFilter_HDR 			{										\
					UINT32				uHDR_filterFunc				 : 16;		\
					UINT32				uHDR_filterState			 :  8;		\
					UINT32				uHDR_isByPassMode			 :  1;		\
					UINT32				uHDR_isEncrypted			 :  1;		\
					UINT32				uHDR_isBusEncOn				 :  1;		\
					UINT32				_x00000	:  5;							\
										}
	/* @'00000 */	union {	UINT32		u32DRMBDFilter_HDR;
	...
	#define	w32DRMBDFilter_IO 			{										\
					UINT32				uIO_strmInPtr				 : 16;		\
					UINT32				uIO_strmOutPtr				 : 16;		\
										}
	/* @'00004 */	union {	UINT32		u32DRMBDFilter_IO;
	...
	#define	w32DRMBDFilter_D3th_ 		{										\
					UINT32				u_datMaxSize				 : 16;		\
					UINT32				u_ctrlMaxSize				 : 16;		\
										}
	...
	#define	w32DRMBDFilter_D4th_ 		{										\
					UINT32				u_packStartOffset			 : 16;		\
					UINT32				u_packSizeToRd				 : 16;		\
										}
	...
	#define	w32DRMBDFilter_CTR 			{										\
					UINT32				uCTR_strmCtrIn				 : 32;		\
										}
	/* @'00014 */	union {	UINT32		u32DRMBDFilter_CTR;
	...
	UINT32	_PAD_000[(0x000E0-0x000D8)/4];
	...
	#define	w32DRMBDFilter_D68th_ 		{										\
					UINT32				u_beBlockCnt				 : 16;		\
					UINT32				u_beReserved				 : 16;		\
										}
	...
	#define	w32DRMBDFilter_D69th_ 		{										\
					UINT32				u_busKeyCtxAddr				 : 16;		\
					UINT32				u_BEpackSizeToRd			 : 16;		\
										}
	...
	UINT32	_PAD_001[(0x00120-0x00118)/4];
} SIE_DRMBDFilter;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMBDFilter_drvrd (SIE_DRMBDFilter *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMBDFilter_drvwr (SIE_DRMBDFilter *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMBDFilter_cmp   (SIE_DRMBDFilter *p, SIE_DRMBDFilter *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMBDFilter_import(SIE_DRMBDFilter *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMBDFilter_export(SIE_DRMBDFilter *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	CtrlFIFOData_drvrd (SIE_CtrlFIFOData *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	CtrlFIFOData_drvwr (SIE_CtrlFIFOData *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	CtrlFIFOData_cmp   (SIE_CtrlFIFOData *p, SIE_CtrlFIFOData *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	CtrlFIFOData_import(SIE_CtrlFIFOData *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	CtrlFIFOData_export(SIE_CtrlFIFOData *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	KeySeedData_drvrd (SIE_KeySeedData *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	KeySeedData_drvwr (SIE_KeySeedData *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	KeySeedData_cmp   (SIE_KeySeedData *p, SIE_KeySeedData *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	KeySeedData_import(SIE_KeySeedData *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	KeySeedData_export(SIE_KeySeedData *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	UpTKCtrlFIFO_drvrd (SIE_UpTKCtrlFIFO *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	UpTKCtrlFIFO_drvwr (SIE_UpTKCtrlFIFO *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	UpTKCtrlFIFO_cmp   (SIE_UpTKCtrlFIFO *p, SIE_UpTKCtrlFIFO *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	UpTKCtrlFIFO_import(SIE_UpTKCtrlFIFO *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	UpTKCtrlFIFO_export(SIE_UpTKCtrlFIFO *p, char *regs);
...
typedef struct SIE_DRMDiagMultiBDCtx {
	...
	UINT32	_PAD_002[(0x02C00-0x008A0)/4];
	...
	#define	w32DRMDiagMultiBDCtx_DTCMSIZE {										\
					UINT32				uDTCMSIZE_uTotalSize		 : 16;		\
					UINT32				_x03E10	: 16;							\
										}
	/* @'03E10 */	union {	UINT32		u32DRMDiagMultiBDCtx_DTCMSIZE;
	...
	UINT32	_PAD_003[(0x03E30-0x03E24)/4];
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMDiagMultiBDCtx_drvrd (SIE_DRMDiagMultiBDCtx *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMDiagMultiBDCtx_drvwr (SIE_DRMDiagMultiBDCtx *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMDiagMultiBDCtx_cmp   (SIE_DRMDiagMultiBDCtx *p, SIE_DRMDiagMultiBDCtx *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMDiagMultiBDCtx_import(SIE_DRMDiagMultiBDCtx *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMDiagMultiBDCtx_export(SIE_DRMDiagMultiBDCtx *p, char *regs);
...
typedef struct SIE_DRMWMFilter {
	...
	/* @'00000 */	union {	UINT32		u32DRMWMFilter_HDR;
	...
	/* @'00004 */	union {	UINT32		u32DRMWMFilter_IO;
	...
	#define	w32DRMWMFilter_D4th_ 		{										\
					UINT32				u_payLoadSize				 : 16;		\
					UINT32				u_payLoadToRead				 : 16;		\
										}
	...
	/* @'00014 */	union {	UINT32		u32DRMWMFilter_CTR;
	...
	#define	w32DRMWMFilter_D32th_ 		{										\
					UINT32				u_isKeySet					 : 16;		\
					UINT32				u_isKSeedOK					 : 16;		\
										}
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMWMFilter_drvrd (SIE_DRMWMFilter *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMWMFilter_drvwr (SIE_DRMWMFilter *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMWMFilter_cmp   (SIE_DRMWMFilter *p, SIE_DRMWMFilter *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMWMFilter_import(SIE_DRMWMFilter *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMWMFilter_export(SIE_DRMWMFilter *p, char *regs);
...
typedef struct SIE_DRMDiagWMFilterCtx {
	...
	UINT32	_PAD_000[(0x02000-0x000A0)/4];
	...
	/* @'03898 */	union {	UINT32		u32DRMDiagWMFilterCtx_DTCMSIZE;
	...
	#define	w32DRMDiagWMFilterCtx_D3623th_ {									\
					UINT32				u_padding_0i				 : 16;		\
					UINT32				u_padding_1i				 : 16;		\
										}
	...
	#define	w32DRMDiagWMFilterCtx_D3624th_ {									\
					UINT32				u_padding_2i				 : 16;		\
					UINT32				u_padding_3i				 : 16;		\
										}
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMDiagWMFilterCtx_drvrd (SIE_DRMDiagWMFilterCtx *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMDiagWMFilterCtx_drvwr (SIE_DRMDiagWMFilterCtx *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMDiagWMFilterCtx_cmp   (SIE_DRMDiagWMFilterCtx *p, SIE_DRMDiagWMFilterCtx *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMDiagWMFilterCtx_import(SIE_DRMDiagWMFilterCtx *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMDiagWMFilterCtx_export(SIE_DRMDiagWMFilterCtx *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	ROM_RSAK_CTX_drvrd (SIE_ROM_RSAK_CTX *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	ROM_RSAK_CTX_drvwr (SIE_ROM_RSAK_CTX *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	ROM_RSAK_CTX_cmp   (SIE_ROM_RSAK_CTX *p, SIE_ROM_RSAK_CTX *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	ROM_RSAK_CTX_import(SIE_ROM_RSAK_CTX *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	ROM_RSAK_CTX_export(SIE_ROM_RSAK_CTX *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRM_BG2_DROM_drvrd (SIE_DRM_BG2_DROM *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRM_BG2_DROM_drvwr (SIE_DRM_BG2_DROM *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRM_BG2_DROM_cmp   (SIE_DRM_BG2_DROM *p, SIE_DRM_BG2_DROM *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRM_BG2_DROM_import(SIE_DRM_BG2_DROM *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRM_BG2_DROM_export(SIE_DRM_BG2_DROM *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	CUSTKEY_CTX_drvrd (SIE_CUSTKEY_CTX *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	CUSTKEY_CTX_drvwr (SIE_CUSTKEY_CTX *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	CUSTKEY_CTX_cmp   (SIE_CUSTKEY_CTX *p, SIE_CUSTKEY_CTX *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	CUSTKEY_CTX_import(SIE_CUSTKEY_CTX *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	CUSTKEY_CTX_export(SIE_CUSTKEY_CTX *p, char *regs);
...
typedef struct SIE_CUSTKEY_MAGICNUM {
	...
	/* @'00000 */	union {	UINT32		u32CUSTKEY_MAGICNUM_DAT;
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	CUSTKEY_MAGICNUM_drvrd (SIE_CUSTKEY_MAGICNUM *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	CUSTKEY_MAGICNUM_drvwr (SIE_CUSTKEY_MAGICNUM *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	CUSTKEY_MAGICNUM_cmp   (SIE_CUSTKEY_MAGICNUM *p, SIE_CUSTKEY_MAGICNUM *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	CUSTKEY_MAGICNUM_import(SIE_CUSTKEY_MAGICNUM *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	CUSTKEY_MAGICNUM_export(SIE_CUSTKEY_MAGICNUM *p, char *regs);
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	BG2_SIGNK_CTX_drvrd (SIE_BG2_SIGNK_CTX *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	BG2_SIGNK_CTX_drvwr (SIE_BG2_SIGNK_CTX *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	BG2_SIGNK_CTX_cmp   (SIE_BG2_SIGNK_CTX *p, SIE_BG2_SIGNK_CTX *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	BG2_SIGNK_CTX_import(SIE_BG2_SIGNK_CTX *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	BG2_SIGNK_CTX_export(SIE_BG2_SIGNK_CTX *p, char *regs);
...
typedef struct SIE_DRMROM_BG2_SRAM {
	...
	UINT32	_PAD_000[(0x00FF0-0x00ED0)/4];
...
/* Member function: read (or self test read) from SRAM or flat register interface and return words read */
INT32	DRMROM_BG2_SRAM_drvrd (SIE_DRMROM_BG2_SRAM *p, UINT32 u32base, INT32 bMEM, INT32 bST);

/* Member function: generate write-commands or direct-write (or self test write) and return write count */
INT32	DRMROM_BG2_SRAM_drvwr (SIE_DRMROM_BG2_SRAM *p, UINT32 u32base, INT32 bMEM, INT32 bST, UINT32 *pu32cmd);
...
INT32	DRMROM_BG2_SRAM_cmp   (SIE_DRMROM_BG2_SRAM *p, SIE_DRMROM_BG2_SRAM *pie, char *ps8name, UINT32 hfpErrLOG, INT32 bMEM, INT32 bST);

/* Member function: import interface values from a text string of compact all bits */
INT32	DRMROM_BG2_SRAM_import(SIE_DRMROM_BG2_SRAM *p, char *regs);

/* Member function: export interface values to a text string of compact all bits */
INT32	DRMROM_BG2_SRAM_export(SIE_DRMROM_BG2_SRAM *p, char *regs);
