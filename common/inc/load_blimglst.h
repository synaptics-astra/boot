 ...
 */
#ifndef _LOAD_BLIMGLST_H_
#define _LOAD_BLIMGLST_H_

#include "bootloader_header.h"
#include "img_layout.h"

#define IMAGE_NON_EXIST		(-1)

#define JTAG_DEBUG_IMAGE_NAME "jtag_enable"
#define BOOTLOADER_IMAGE_NAME "bootloader_en"
#define TRUSTZONE_IMAGE_NAME     "tz_en"
